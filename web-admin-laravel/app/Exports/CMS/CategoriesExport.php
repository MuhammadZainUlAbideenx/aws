...
class CategoriesExport implements FromArray,WithHeadings,ShouldAutoSize, WithEvents, WithTitle, WithStyles
{
    /**
    * @return \Illuminate\Support\Collection
    */
    protected $catgeories;
    ...
    public function array(): array
    {
      ...
      foreach ($this->categories as $key=>$category) {
        ...
        $single = [++$key,$category->name,$category->slug,$is_active];
        $data[] = $single;
      }
      return $data;
    }
