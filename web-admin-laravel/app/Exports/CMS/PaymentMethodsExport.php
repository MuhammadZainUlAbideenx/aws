...
class PaymentMethodsExport implements FromArray,WithHeadings,ShouldAutoSize, WithEvents, WithTitle, WithStyles
{
    /**
    ...
    */
    ...
    public function array(): array
    {
      ...
      foreach ($this->payment_methods as $key=>$payment_method) {
        ...
        $single = [++$key,$payment_method->name,$payment_method->code ,$is_active ];
        $data[] = $single;
      }
      return $data;
    }
    public function headings(): array{
      return ["Sr","Name","Code","Status"];
    }
}
