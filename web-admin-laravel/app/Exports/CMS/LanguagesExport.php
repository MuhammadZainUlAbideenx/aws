...
class LanguagesExport implements FromArray,WithHeadings,ShouldAutoSize, WithEvents, WithTitle, WithStyles
{
    /**
    ...
    */
    ...
    public function array(): array
    {
      ...
      foreach ($this->languages as $key=>$language) {
        ...
        $single = [++$key,$language->name,$language->code,$language->direction, $is_active];
        $data[] = $single;
      }
      return $data;
    }
    public function headings(): array{
      return ["Sr","Name","Code","Direction" , " Status"];
    }
}
