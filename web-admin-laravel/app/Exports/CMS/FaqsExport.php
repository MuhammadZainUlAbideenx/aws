...
class FaqsExport implements FromArray,WithHeadings,ShouldAutoSize, WithEvents, WithTitle, WithStyles
{
    /**
    ...
    */
    ...
    public function array(): array
    {
      ...
      foreach ($this->faqs as $key=>$faq) {
        ...
        $single = [++$key, $faq->product ? $faq->product->name : '',$is_active ,strip_tags($faq->question),strip_tags($faq->answer)];
        $data[] = $single;
      }
      return $data;
    }
    public function headings(): array{
      return ["Sr","Product","Status","Question","Answer"];
    }
}
