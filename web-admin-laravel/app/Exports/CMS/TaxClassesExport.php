...
class TaxClassesExport implements FromArray,WithHeadings,ShouldAutoSize, WithEvents, WithTitle, WithStyles
{
    /**
    ...
    */
    ...
    public function array(): array
    {
      ...
      foreach ($this->tax_classes as $key=>$tax_class) {
        ...
        $single = [++$key,$tax_class->name,$is_active, strip_tags($tax_class->description)];
        $data[] = $single;
      }
      return $data;
    }
    public function headings(): array{
      return ["Sr","Name", "Status", "Description"];
    }
}
