...
class RiderPayoutRequestsExport implements FromArray,WithHeadings,ShouldAutoSize, WithEvents, WithTitle, WithStyles
{
    /**
    ...
    */
    ...
    public function array(): array
    {
      ...
      foreach ($this->payoutRequests as $key=>$payoutRequest) {
        ...
        $single = [++$key,$payoutRequest->rider->first_name . " ". $payoutRequest->rider->last_name,$payoutRequest->amount,$payoutRequest->note,$status,date('d-m-Y', strtotime($payoutRequest->created_at))];
        $data[] = $single;
      }
      return $data;
    }
    public function headings(): array{
      return ["Sr","Rider Name","Amount","Note","Status","Date"];
    }
}
