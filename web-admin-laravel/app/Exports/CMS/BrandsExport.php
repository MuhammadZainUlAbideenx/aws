...
class BrandsExport implements FromArray,WithHeadings,ShouldAutoSize, WithEvents, WithTitle, WithStyles
{
    /**
    ...
    */
    ...
    public function array(): array
    {
      ...
      foreach ($this->brands as $key=>$brand) {
        ...
        $single = [++$key,$brand->name,$is_active , $brand->website_url ];
        $data[] = $single;
      }
      return $data;
    }
    public function headings(): array{
      return ["Sr","Name","Status", "Website Url"];
    }
}
