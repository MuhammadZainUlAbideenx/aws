...
class StatesExport implements FromArray,WithHeadings,ShouldAutoSize, WithEvents, WithTitle, WithStyles
{
    /**
    ...
    */
    ...
    public function array(): array
    {
      ...
      foreach ($this->states as $key=>$state) {
        ...
        $single = [++$key,$state->name,$state->countries?$state->countries->name:'',$state->code, $is_active];
        $data[] = $single;
      }
      return $data;
    }
    public function headings(): array{
      return ["Sr","Name","Country","Code", "Status"];
    }
}
