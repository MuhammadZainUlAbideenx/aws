...
class RidersController extends Controller
{
  ...
  public function getter($req = null,$export = null)
  {
    if($req != null){
      ...
      $riders =  Rider::withAll()->with('vendor');
      if($req->column && $req->column != null && $req->search && $req->search != null){
        ...
        $riders = $riders->whereLike($req->column,$req->search);
           ...
           $riders = $riders->whereLike(['first_name','last_name','phone','email','address','role.display_name'],$req->search);
        }
    ...
    $riders = Rider::withAll()->with('vendor')->orderBy('id','desc')->paginate(10);
    $riders = RidersResource::collection($riders)->response()->getData(true);
    return $riders;
  }
  ...
  /********* FETCH ALL Riders ***********/
    ...
    public function export(Request $request)
    {
        ...
        if ($request->export == 'pdf') {
            ...
            return $pdf->setPaper('A4', 'landscape')->download('riders.pdf');
        }
  ...
  /********* FILTER Riders FOR Search ***********/
   public function filter(Request $request){
    ...
    {
        $rider = Rider::withAll()->with('vendor')->find($rider);
    ...
    public function updateProfileImage(Request $request)
    {
        ...
        $customer->update([
          ...
          return response()->json(['profile_image_path' => $customer->profile_image_path, 'success' => 'Your Profile image Has been Uploaded','message' =>  trans('messages.response.riders.image_uploaded')], 200);
    }
