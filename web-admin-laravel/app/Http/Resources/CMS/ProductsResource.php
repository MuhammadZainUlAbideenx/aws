...
use App\Http\Resources\CMS\FlashSaleResource;
use App\Http\Resources\CMS\SpecialSaleResource;
     ...
     if(!$flash_sale && $this->relationLoaded('special_sale')){
      ...
      return [
        ...
        //   'price' =>  number_format($this->price, 2),
          ...
          'numeric_price' => $this->price,
          'stock' => $final_stock,
          'quantity' => $this->quantity,
          'available_date' => $this->available_date,
          'available_date_display' => Carbon::parse($this->available_date)->format($format),
          'weight' => $this->weight,
        ...
        //  'thumbnails' => MediaResource::collection($this->media),
          ...
          'product_ordered' => $this->relationLoaded('order_products') ? count($this->whenLoaded('order_products')) : 0,
