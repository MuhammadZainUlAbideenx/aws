...
class PaymentGatewayRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
          ...
          'cardInfo.number' => 'required_if:payment_method_code,stripe,braintree,paytm|nullable|min:16|max:16',
          'cardInfo.exp_month' => 'required_if:payment_method_code,stripe,braintree,paytm|nullable|min:2|max:2',
          'cardInfo.exp_year' => 'required_if:payment_method_code,stripe,braintree,paytm|nullable|min:2|max:2',
          'cardInfo.cvc' => 'required_if:payment_method_code,stripe,braintree,paytm|nullable|min:3|max:3',
