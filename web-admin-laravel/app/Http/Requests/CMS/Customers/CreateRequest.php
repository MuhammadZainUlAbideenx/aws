...
class CreateRequest extends FormRequest
{
    ...
    {
        return [
          'password' => 'required_if:is_credentials,1|same:password_confirmation|min:8',
          'first_name' => 'required|string|max:25|min:3',
          'last_name' => 'string|max:25|min:3',
          'gender' => 'required|string|max:255',
          'email' => 'required_if:is_credentials,1|email|max:255|unique:customers',
          'phone' => 'string|max:16|min:6',
