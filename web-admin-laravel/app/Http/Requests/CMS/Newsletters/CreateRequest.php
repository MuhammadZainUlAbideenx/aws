...
namespace App\Http\Requests\CMS\Newsletters;
...
class CreateRequest extends FormRequest
{
    ...
    public function attributes(){
      ...
      $allAttributes['is_verified'] = trans('messages.fields.is_verified');
    ...
    //   $allRules['email'] = 'required|email:rfc,dns|unique:newsletters';
      $allRules['email'] = 'required|email|unique:newsletters';
      return $allRules;
    }
}
