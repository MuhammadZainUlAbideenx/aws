...
namespace App\Http\Requests\CMS\Categories;
...
class CreateRequest extends FormRequest
{
    ...
    public function attributes(){
      ...
      $allAttributes['icon_id'] = trans('messages.fields.icon');
      $allAttributes['parent_id'] = trans('messages.fields.parent_category');
    ...
    public function rules()
    {
      ...
      $allRules['icon_id'] = 'required|exists:media,id';
      $allRules['parent_id'] = 'sometimes|exists:categories,id|nullable';
      $allRules['is_featured'] = 'required|bool';
