...
namespace App\Http\Requests\CMS\Newses;
...
class CreateRequest extends FormRequest
{
    ...
    public function attributes(){
      ...
      $allAttributes['is_featured'] = trans('messages.fields.is_featured');
    ...
    public function rules()
    {
      ...
      $allRules['news_category_id'] = 'required';
      $allRules['is_featured'] = 'required';
