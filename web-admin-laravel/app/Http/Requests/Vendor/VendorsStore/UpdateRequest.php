...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
      ...
      // $allRules['name'] = 'required|string|min:3|max:18';
      // $allRules['email'] = 'email|unique:vendors,email,'.$vendor->id;
      // $allRules['contact_phone'] = 'required|min:5|max:18';
    //   $allRules['logo_image_id'] = 'required|exists:media,id';
    //   $allRules['cover_image_id'] = 'required|exists:media,id';
      // $allRules['password'] = 'nullable|same:password_confirmation|min:8';
      ...
      $allRules['store_details.headline'] = 'required|string|min:3|max:30';
      ...
      $allRules['store_details.postal_code'] = 'required|max:18';
      $allRules['categories'] = 'required|exists:categories,id|max:2';
      return $allRules;
    }
}
