                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Thank you for being our valued customer. We hope
                                                                        our product will meet your expectations.</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                                    ...
                                                                    <table
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            <td style="padding:0;Margin:0"><span
                                                                                    ...
                                                                                    #:</span></td>
                                                                            <td style="padding:0;Margin:0"><span
                                                                                    style="font-size:14px;line-height:21px">{{ $order->order_number }}</span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr style="border-collapse:collapse">
                                                                            <td style="padding:0;Margin:0"><span
                                                                                    ...
                                                                                    Date:</span></td>
                                                                            <td style="padding:0;Margin:0"><span
                                                                                    style="font-size:14px;line-height:21px">{!! date('d/M/y', strtotime($order->created_at)) !!}</span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr style="border-collapse:collapse">
                                                                            <td style="padding:0;Margin:0"><span
                                                                                    ...
                                                                                    Total:</span></td>
                                                                            <td style="padding:0;Margin:0"><span
                                                                                    style="font-size:14px;line-height:21px">{{ attachCurrencyDecimal($order->total) }}</span>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    <p
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                @if ($orders_products)
                                                                    ...
                                                                    @foreach ($orders_products as $orders_product)
                                                                        @php
                                                                            if ($orders_product->product && $orders_product->product->media && count($orders_product->product->media) > 0) {
                                                                                $media_url = str_replace('/api', '', $orders_product->product->media[0]->original_media_path);
                                                                            }
                                                                        ...
                                                                        @if (isset($media_url))
                                                                            <td align="center"
                                                                                ...
                                                                                <img src="{{url($media_url)}}" width="125" alt="{{url($media_url)}}" />
                                                                            </td>
                                                                        @endif
                                                                    @endforeach
                                                                @endif
                                                                        ...
                                                                        @if ($orders_products)
                                                                            ...
                                                                            @foreach ($orders_products as $orders_product)
                                                                                <tr style="border-collapse:collapse">
                                                                                    ...
                                                                                    <td
                                                                                        style="padding:0;Margin:0;width:100px;text-align:center">
                                                                                        {{ attachCurrencyDecimal($orders_product->product->price) }}
                                                                                    </td>
                                                                                </tr>
                                                                            @endforeach
                                                                        @endif
                                                                    ...
                                                                    <table
                                                                        ...
                                                                        @if ($order->shipping_price)
                                                                            <tr style="border-collapse:collapse">
                                                                                ...
                                                                                <td
                                                                                    ...
                                                                                    {{ attachCurrencyDecimal($order->shipping_price) }}
                                                                                </td>
                                                                            </tr>
                                                                        @endif
                                                                        @if ($order->coupon_amount)
                                                                            <tr style="border-collapse:collapse">
                                                                                ...
                                                                                <td
                                                                                    style="padding:0;Margin:0;text-align:right;font-size:18px;line-height:27px">
                                                                                    {{ attachCurrencyDecimal($order->coupon_amount) }}
                                                                                </td>
                                                                            </tr>
                                                                        @endif
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            ...
                                                                            <td
                                                                                style="padding:0;Margin:0;text-align:right;font-size:18px;line-height:27px;color:#d48344">
                                                                                <strong>{{ attachCurrencyDecimal($order->total) }}</strong>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    <p
