<template>
  ...
  <section v-else id="tc_body"
    ...
    <!--begin::Header Mobile-->
    <SellerMobileHeader @show-navbar="themeData.shownav = !themeData.shownav"
    ...
    <div class="d-flex flex-column flex-root">
      ...
      <div class="d-flex flex-row flex-column-fluid page">
        <!--begin::Aside-->
        <SellerSidebar :class="{ 'aside_on aside-overlay': themeData.showsidebar }" :themeData="themeData" />
        <div class="aside-overlay"></div>
        <!--end::Aside-->
        <!--begin::Wrapper-->
        <div class="d-flex flex-column flex-row-fluid wrapper position-relative" id="tc_wrapper">
          <!--begin::Header-->
          <SellerNavbar  @change_direction="changeThemeDirection" :class="{ 'hidemobilenavbar slide-in-top': themeData.shownav }" />
          <!--end::Header-->
          <!--begin::Content-->
    ...
    <SellerOffCanvas @changeDirection="changeDirection"
