<template>
  ...
  <div id="tc_header" class="header header-on animate__animated animate__fadeInDown">
    <!--begin::Container-->
      ...
      <div class="topbar row p-0 m-0">
        <div class="col-md-6 px-4">
          <div class="d-flex align-items-center">
                    <!--begin::Toggle-->
                    <div class="toggle-btn" id="tc_aside_toggle"  @click="sidebarCollapse">
  ...
  <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/>
            ...
            <div class="topbar-item w-100 position-relative">
              <div class="quick-search quick-search-inline ml-20 mr-1 w-100 rounded" id="kt_quick_search_inline">
                <!--begin::Form-->
                <form method="get" class="quick-search-form">
                  <div class="form-group has-search">
                    <button class="btn border-0 bg-gradient-secondary form-control-feedback top-0 end-0 text-white rounded btn">
  ...
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
                ...
                <div class="dropdown-menu dropdown-menu-left dropdown-menu-lg dropdown-menu-anim-up">
                  <div class="quick-search-wrapper scroll ps"
                       data-scroll="true"
                       data-height="350"
        ...
        <div class="col-md-6 d-flex justify-content-end p-0 m-0">
          <div class="d-flex align-items-center justify-content-end h-48  profile-bar px-1">
            <!--begin::Languages-->

            <div class="dropdown me-3">
              <div class="topbar-item dropdown-toggle"
                   id="dropdownMenu1"
                   data-toggle="dropdown"
                   data-display="static"
                ...
                <div class="btn btn-icon btn-clean btn-dropdown btn-lg">
                  <img class="h-20px w-20px rounded-sm"
                       :src="
                       `/backend/api/flags/png100px/${currentLocale.code}.png`
                      "
                       alt="" />
                </div>
              </div>
            ...
            <div class="dropdown">
              <div class="topbar-item">
                <div class="btn btn-icon btn-clean mr-1"
            ...
            <div class="dropdown me-2 notifications">
              ...
              <div class="dropdown-menu p-0 m-0 dropdown-menu shadow"
                ...
                <form>
                  <div class="d-flex flex-column p-3 border-bottom rounded-top">
                    <h4 class="d-flex justify-content-between align-items-center mb-0 rounded-top">
                      <span class="font-size-h5">{{this.$t("navbar.Notifications") }}</span>
                      <nuxt-link to=""
                    ...
                    <nuxt-link to="" class="nav-item border-bottom">
                      <div class="nav-link">
                        ...
                        <div class="nav-text">
                          ...
                          <div class="text-muted">{{this.$t("navbar.Time") }}</div>
                        </div>
                      </div>
                    </nuxt-link>
                    <nuxt-link to="" class="nav-item border-bottom">
            ...
            <div class="dropdown h-100">
              <div class="topbar-item"
                   ...
                   aria-expanded="false"
                   data-offset="0px,1px">
                <div class=" btn-icon w-auto btn-clean d-flex align-items-center mx-0 mx-lg-4">
                  <span v-if="$auth.loggedIn" class="font-size-base d-none d-md-inline me-2 text-capitalize">
                      <!-- AngilinaDeo -->
                        {{ $auth.user.name }}
                      </span
                    >
                    <span
                      class="symbol symbol-35 symbol-light-success profile-icon rounded-circle mx-md-1 mx-3"
                    >
              ...
              <div class="dropdown-menu dropdown-menu-right shadow"
                ...
                <nuxt-link to="/seller/profile" class="dropdown-item">
                  <span class="svg-icon svg-icon-xl svg-icon-primary mr-2">
                    ...
                    </span>   {{$t('form.admin.profile.edit')}}
                </nuxt-link>
