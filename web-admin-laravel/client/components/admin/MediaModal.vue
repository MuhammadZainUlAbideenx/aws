  ...
  <div class="modal-dialog ">
    <div class="modal-content">
      ...
      <div class="modal-footer py-5">
        ...
        <nuxt-link :to="localePath(`/${redirect_panel}/media`)"  target="_blank" class="btn btn-primary py-2 px-4 shadow">{{ $t('upload')}}</nuxt-link>
...
export default {
  ...
  props:['modal_id','img_var','bind_modal','type', 'redirect_panel'],
  methods: {
    ...mapActions({
