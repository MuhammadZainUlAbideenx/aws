<template>
  <Footer>
    <div class="footer_layout_nine">
      <div class="footer bg-dark mt-5 px-3 px-md-0" v-if="allFooterData">
        <div class="container">
          <div class="row">
            <div class="col-12">
          ...
          <div class="row py-4">
            ...
            <div class="col-md-3 mt-md-0 mt-4">
              <div class="popular-tags">
                <h6 class="text-white  contact fs-5">Popular Tags</h6>
                <div class="tags d-block mt-4">
