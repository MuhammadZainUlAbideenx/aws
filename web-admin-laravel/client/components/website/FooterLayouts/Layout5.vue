      ...
      >
        <div class="container">
          <div class="row border-bottom-light pt-5 pb-md-5">
            ...
            <div class="col-lg-3 col-md-3 col-6 mt-md-0 mt-4">
              <h6 class="text-uppercase fw-bold text-white fs-5">
                {{ $t("customer_care") }}
              </h6>
              <ul class="page-list">
            ...
            <div
              class="col-lg-3 col-md-3 col-6 mt-md-0 mt-4"
            ...
            >
              ...
              <form class="position-relative overflow-hidden">
                <input
          ...
          <div class="row py-4">
            <div class="col-lg-6 text-center text-md-start pb-2 py-md-2 text-white">
