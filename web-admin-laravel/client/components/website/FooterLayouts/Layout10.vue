<template>
  <Footer>
    <div class="footer_layout_ten">
      <div class="footer bg-dark mt-5 px-3 px-md-0 pt-5" v-if="allFooterData">
        <div class="container">
          <div class="row py-5 mb-4">
            <div class="col-md-3 mt-md-0 mt-4 d-flex flex-column justify-content-center">
              <div class="footer-logo">
                <a href="">
                  <img
                    src="~/assets/images/nictus-logo-white.png"
                    alt=""
                    class="img-fluid"
                  />
                </a>
            ...
            <div class="col-md-3 mt-md-0 mt-4">
              <div class="content-info">
                <h6 class="text-white  contact fs-5">CONTACT INFO</h6>
                <p class="text-white mb-0 address">ADDRESS:</p>
                <p class="street-adress">123 Street Name, City, England</p>
                <p class="text-white mb-0 address">PHONE:</p>
                <p class="street-adress">{{ allFooterData.contactDetails.contact_number }}</p>
                <p class="text-white mb-0 address">EMAIL:</p>
                <p class="street-adress"><a href="">{{
                      allFooterData.contactDetails.contact_email
                    }}</a></p>
                <!-- <p class="text-white mb-0 address">WORKING DAYS/HOURS:</p>
                <p class="street-adress">Mon - Sun / 9:00 AM - 8:00 PM</p> -->
            ...
            <div class="col-md-3 mt-md-0 mt-4">
              <div class="news-letter">
                <h6 class="text-white  contact fs-5">SUBSCRIBE NEWSLETTER</h6>
                <p class="mb-0 mt-4">
                ...
                <form action="">
                    <div class="input-group d-block">
                      <input
                        type="text"
                        class="form-control w-100 mt-3 text-white"
                        placeholder="Email Address"
                        aria-label="Recipient's username"
                        aria-describedby="basic-addon2"
                      />
                      <button
                        class="input-group-text  text-white fw-bold btn btn-primary mt-3 w-50"
                        id="basic-addon2"
                        >Subscribe</button
                      >
                    </div>
          ...
          <div class="row py-2 bg-dark border-top-c">
            <div
              class="
                col-lg-6 col-12
