<template>
  <div class="card_layout_four pt-4">
    <div class="card m-0 p-0 pb-3 bg-transparent ps-3 pe-3 h-100 border-0 rounded-0 overflow-hidden card-border">
      <div
        class="
          p-0
          bg-light
      ...
      >
        ...
        <img
          ...
          alt=""
        />
        <span class="position-absolute tool-tip bg-primary  text-white">
            <a
              href="#"
      ...
      <div class="text-section ps-2 d-flex flex-column justify-content-center align-items-center">
        ...
        <span class="w-100 d-block text-dark-50 text-center" v-if="product.flash_sale"
        ...
        <span
          class="w-100 d-block text-dark-50"
     ...
     <span class="text-decoration-line-through">
        ...
        <span class="product-price d-flex align-items-center" v-else>
        ...
        <div class="d-flex align-items-center">
          <button
            ...
            class="btn btn-primary border-0 text-uppercase btn-hover"
          >
