<template>
  <div class="card_layout_two pt-4 text-center">
    <div class="card m-0 p-0 pb-5 bg-transparent h-100 border-0 rounded-0 overflow-hidden pe-3 ps-3">
      <div
        class="
          p-0
          bg-light
