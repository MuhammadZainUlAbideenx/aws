<template>
  <header class="header_layout_six">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          >
            <form action="">
              <div
                class="input-group position-relative inputgroup-width mx-auto"
              >
                <input
                  type="text"
                  class="form-control rounded text-body place-color custom-border bg-secondary"
                  placeholder=""
    ...
    <div class="bottom-nav bg-primary">
      <div class="container">
        <div class="row align-items-center">
              ...
              <div class="dropdown mb-dropdown-1 d-none">
                <button
                  class="
                    ...
                    bg-transparent
                    position-relative
                    dropdown-toggle dropdown-toggle-custom
                  "
                  type="button"
                  id="dropdownMenuButton1"
                  data-bs-toggle="dropdown"
              ...
              >
                <ul class="navbar-nav nav-links">
                  <li class="nav-item home-item dropdown">
                    <nuxt-link
                      to="/"
                      class="nav-link px-lg-3 text-uppercase text-white"
                    >
