<template>
  <header class="shadow header_layout_nine">
    <div class="topbar bg-primary d-none">
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-4 col-6 mt-2 mt-md-0">
            <div
              class="top-menu d-flex flex-row justify-content-between"
              v-if="!$auth.loggedIn"
            >
              <div class="info d-flex flex-row flex-row">
                ...
                <div class="register">
                  <a
                    class="d-flex flex-row align-items-center h-100 text-white"
                    v-if="
                      allSettings &&
          ...
          <div
            class="col-lg-4 col-md-4 px-md-0 col-12 my-2 my-md-0 order-section"
          >
    ...
    <div class="search-bar py-md-3 pt-3 bg-white">
      <div class="container">
              ...
              >
                <span class="navbar-toggler-icon">
                  <svg
                    ...
                    viewBox="0 0 448 512"
                    class="me-3 svg-inline--fa fa-bars fa-w-14 display-bar"
                  >
                    <path
                      data-v-709ec6b1=""
                      fill="currentColor"
                  ...
                  >
                    ...
                    >
                      <div class="search w-100">
                        <div class="bg-secondary p-3 rounded mb-position">
                          <input
                            type="text"
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        ...
                        "
                      >
                        <div class="position-absolute badge-9">
    ...
    <div class="topbar bg-primary topbar-sm-none">
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-4 col-6 mt-2 mt-md-0">
            <div
