<template>
  <header class="header_layout_ten">
    <div class="top bg-primary d-flex align-items-center">
      <div class="container">
                ...
                >
                  <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="img-wrap me-2">
                      <img
                        class="h-auto w-20px rounded-sm"
    ...
    <div class="topbar">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-4 col-6 mt-md-0 d-flex justify-content-start">
            <form action="">
              <div class="input-group position-relaive">
                <input
                  type="text"
                  class="form-control form-control-1 bg-secondary"
                  placeholder="Search Product"
                  aria-label="Recipient's username"
                  aria-describedby="basic-addon2"
                />
                <div class="position-absolute icon-size">
                  <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 50 50" width="25px" height="50px" class="text-dark"><path d="M 21 3 C 11.654545 3 4 10.654545 4 20 C 4 29.345455 11.654545 37 21 37 C 24.701287 37 28.127393 35.786719 30.927734 33.755859 L 44.085938 46.914062 L 46.914062 44.085938 L 33.875 31.046875 C 36.43682 28.068316 38 24.210207 38 20 C 38 10.654545 30.345455 3 21 3 z M 21 5 C 29.254545 5 36 11.745455 36 20 C 36 28.254545 29.254545 35 21 35 C 12.745455 35 6 28.254545 6 20 C 6 11.745455 12.745455 5 21 5 z"/></svg>
                </div>
              </div>
            </form>
          </div>

          <div class="col-md-4 col-12 logo-left">
          ...
          >
            <div
              class="top-menu d-flex flex-row justify-content-end"
              v-if="!$auth.loggedIn"
            >
    ...
    <div class="search-bar  nav-color">
      <div class="container">
        <div
          class="row align-items-center justify-content-center py-1 rounded-c"
        >
