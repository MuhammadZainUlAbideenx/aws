<template>
  <header class="header_layout_four">
    <div class="topbar">
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-4 col-6 logo-left">
            <div class="logo d-flex justify-content-center mb-4 mb-md-0">
          ...
          <div class="col-md-4 col-10 d-flex justify-content-end align-items-center mb-block">
    ...
    <div class="search-bar  bg-white">
      <div class="container">
        <div class="row align-items-center justify-content-center  py-3 rounded-c">
          <div class="col-md-12 col-12 nav-mbl-1">
            <nav class="navbar navbar-expand-lg py-0 nav-color">
              ...
              <div class="collapse navbar-collapse justify-content-center w-100 bg-white" id="navbarNavDropdown">
                <ul class="navbar-nav nav-links px-3 bg-white justify-content-center">
