<template>
  <header class="header_layout_eight">
    <div class="top-bar d-none d-md-block py-3">
      <div class="container">
    ...
    <div class="bottom-nav bg-primary py-2 d-none d-md-block">
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6 col-12 order-small-c d-flex justify-content-center d-none d-md-flex">
            <form action="">
    ...
    <div class="top-bar d-none top-bar-1">
      <div class="container">
        <div class="row align-items-center">
    ...
    <div class="bottom-nav bg-primary py-2 d-none bottom-nav-1">
      <div class="container">
        <div class="row align-items-center">
          <div
            class="
