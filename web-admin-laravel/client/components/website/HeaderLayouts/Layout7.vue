<template>
  <header class="header_layout_seven">
    <div class="top-min-nav d-flex align-items-center">
      <div class="container">
        <div class="row">
          <ul class="nav nav-inline justify-content-center">
            <li class="ms-4"><a href="">30 days free return</a></li>
            <li class="ms-4"><a href="">FREE SHIPPING FOR OVER $40</a></li>
            <li class="ms-4"><a href="">BEST WORLDWIDE DELIVERY</a></li>
          </ul>
          <!-- <div class="col-6">
            <div class="d-flex align-items-center h-100 me-4 mb-dropdown-1">
              <div class="dropdown">
                <a class="
                  dropdown-toggle
                  d-flex
          ...
          <div class="col-6"  v-if="
            ...
            <div class="phone d-flex justify-content-end">
                {{
                      allSettings.general_settings.contact_number
                    }}
            </div>
          </div> -->
          <div class="col-12 d-none header-6-seller">
            <div
              class="top-menu d-flex flex-row justify-content-center"
              v-if="!$auth.loggedIn"
            >
              <div class="info d-flex flex-row flex-row justify-content-end">
                ...
                <div class="register">
                  <a
                    class="d-flex flex-row align-items-center h-100 text-dark"
                    v-if="
                      allSettings &&
                      allSettings.general_settings &&
    ...
    <div class="top-bar bg-primary">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-2 col-md-3 col-6 mb-dropdown">
           <div class="d-flex">
            <div class="dropdown">
              <a class="
                  dropdown-toggle
            ...
            <div class="dropdown me-0">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li v-for="currency in availableCurrencies" @click="changeCurrency(currency.code)" :key="currency.code">
                  <a class="dropdown-item" href="#">{{ currency.name }}</a>
                </li>
              </ul>
            </div>
          ...
          >
            <div class="d-flex justify-content-center">
              ...
              <!-- <form action="" >
              <div class="input-group position-relative inputgroup-width mx-auto">
                <input type="text" class="form-control rounded custom-border" placeholder="Search your fav itemes here" aria-label="Recipient's username"
                  aria-describedby="button-addon2">
                <div class="position-absolute svg-search">
                  <svg fill="#000000" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="530px"
                    height="50px">
                    <path
          ...
          <div class="col-lg-2 col-md-3 col-12 my-3 mb-mobile">
            <div
              class="
                d-flex
                align-items-center
              ...
              <div class="top-site-icons">
                ...
                >
                  ...
                  >
                    <a
                      id="search-input"
                      data-bs-target="#cartcollapse2"
                      data-bs-toggle="collapse"
                      href="#cartcollapse2"
                      role="button"
                      aria-expanded="false"
                      aria-controls="cartcollapse2"
                    >
                      <svg
                    ...
                    >
                      ...
                      >
                        <div class="search w-100">
                          ...
                          >
                            <div
                              class="autosuggest__results-container text-center"
                            >
                  ...
                  <li>
                    ...
                    >
                      ...
                      >
                        <img
                          v-if="$auth.user.profile_image_path"
                          class="rounded-circle border profile-photo w-100"
                          v-bind:src="url + `${$auth.user.profile_image_path}`"
                          alt="profile_image"
                        />
                        <img
                  ...
                  <li>
                    <nuxt-link
                      to="/wishlist"
                      class="nav-toggle position-relative"
                      id="wishlist"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li class="me-0">
                    <a
                      class="dropdown-toggle nav-toggle position-relative"
                      id="cart"
        ...
        <div class="row align-items-center">
          <div class="col-md-3 col-6 d-none d-md-block">
            <div class="dropdown">
              ...
              <ul
                ...
                v-if="allMegaMenuItems && allMegaMenuItems.categories_1"
              >
                <li
                  class="dropdown-item"
          ...
          <div class="col-md-6 col-12 order-small-c">
            <nav class="navbar navbar-expand-md py-0">
              ...
              <div class="dropdown mb-dropdown-1 d-none">
              <button
                class="
                  border-0
                  bg-transparent
              ...
              <ul
                class="dropdown-menu dropdown-menu-mb-screen"
                aria-labelledby="dropdownMenuButton1"
                v-if="allMegaMenuItems && allMegaMenuItems.categories_1"
              >
                <li
              ...
              >
                <ul class="navbar-nav nav-links align-items-center">
                  <li class="nav-item home-item dropdown ">
                    <nuxt-link
                      to="/"
                      class="d-block py-2 px-lg-3 text-uppercase"
                    >
