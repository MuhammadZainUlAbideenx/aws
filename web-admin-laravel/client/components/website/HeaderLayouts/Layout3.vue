<template>
  <header class="shadow header_layout_three">
    <div class="topbar">
      <div class="container">
        <div class="row">
          <!-- <div class="col-lg-4 col-md-3 col-6 mt-2 mt-md-0">
            <div class="top-menu d-flex flex-row justify-content-between" v-if="!$auth.loggedIn">
              <div class="info d-flex flex-row flex-row mb-0">
                <div class="accounts me-3">
                  <nuxt-link
                    class="
                      d-flex
                      flex-row
                    ...
                    "
                    :to="`/seller/login`"
                    v-if="allDefaultSettings.general_settings.is_multi_vendor"
                  >
                    {{ $t("become_a_seller") }}
                  </nuxt-link>
                </div>
          ...
          <div class="col-lg-4 col-md-4 px-md-0 col-12 mb-2 my-md-0 order-section">
            <div class="welcome-note h-100">
              <a class="
                  d-flex
                  flex-row
                  align-items-center
          ...
          <div class="col-lg-4 col-md-4 col-6 mt-2 mt-md-0">
            <div class="top-menu d-flex flex-row justify-content-end" v-if="!$auth.loggedIn">
    ...
    <div class="search-bar py-md-3 pt-3 bg-secondary">
      <div class="container">
        <div class="row align-items-center bg-white py-3 rounded-c">
          <div class="col-xl-3 col-md-6 col-12">
            <div class="logo d-flex mb-4 mb-md-0">
              <nuxt-link to="/" v-if="allSettings.general_settings.name_or_logo == 1">
                <img :src="`/backend${allSettings.general_settings.logo_dark.original_media_path}`" class="" alt="..."
                  ...
                  " />
                <img :src="`/backend${allSettings.general_settings.logo.original_media_path}`" class="" alt="..."
          ...
          <div class="col-xl-6 col-12 nav-mbl">
              ...
              <div class="collapse navbar-collapse justify-content-center" id="navbarNavDropdown">
                <ul class="navbar-nav nav-links">
                  <li class="nav-item home-item dropdown">
                    <nuxt-link to="/" class="nav-link px-lg-3 text-uppercase">
                      {{ this.$t("web.home.navbar.home.heading") }}
                    </nuxt-link>
                  </li>
                  <li class="nav-item shop-item dropdown">
                    <nuxt-link to="/shop" class="nav-link px-lg-3 text-uppercase">
                  ...
                  <li class="nav-item vendors-item dropdown" v-if="
                    ...
                    allSettings.general_settings.is_multi_vendor == 1
                  ">
                    <nuxt-link class="nav-link px-lg-3 text-uppercase" to="/stores">{{ this.$t("web.home.navbar.stores")
                    }}
                    </nuxt-link>
                  </li>
                  <li class="nav-item vendors-item dropdown">
                    <nuxt-link class="nav-link px-lg-3 text-uppercase" to="/brands">{{ this.$t("web.home.navbar.brands")
                    }}
                    </nuxt-link>
                  </li>

                  <li class="nav-item blog-item dropdown">
                    <nuxt-link to="/blog" class="nav-link px-lg-3 text-uppercase">
                      {{ this.$t("web.home.navbar.blog") }}
                    </nuxt-link>
                  </li>
                  <li class="nav-item about-item dropdown">
                    <nuxt-link to="/aboutus" class="nav-link px-lg-3 text-uppercase">
                  ...
                  <li class="nav-item contact-item dropdown">
                    <nuxt-link
                      to="/contact"
                      class="nav-link px-lg-3 text-uppercase"
                    >
            ...
            <div class="top-site-icons">
              <ul id="navAccordion" class="
                ...
                <li>
                  ...
                  <div v-else class="">
                    <nuxt-link :to="localePath('/login')" class="d-flex flex-row align-items-center h-100 text-body">
                      <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink"
