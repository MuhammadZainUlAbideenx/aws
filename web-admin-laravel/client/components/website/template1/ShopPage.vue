...
<div v-if="$fetchState.pending">
   ...
   <div v-else class="shop-page-wrap section-gap">
      <div class="container">
        <div class="row">
          <div class="col-sm-3">
            ...
            <div class="pro-sec categories-sec">
              ...
              <ul>
                <div
                  v-for="category in shopPageData.categories"
                  :key="category.id"
                >
                  <li
                    :class="
          ...
          <div class="col-sm-9">
            <div class="grig-list-nav d-flex justify-content-between mb-3 bg-secondary">
              <WebsiteGlobalComponentsGrigListView
                :grid_class="grid_class"
                @changeGridClass="changeGridClass"
              />
              <div class="d-flex">
                <div class="dropdown-fild sort-by-item mt-3 mt-md-0 ms-ms-4">
                  <label
                    for="item-per-page"
            ...
            <div class="row" v-else>
              ...
              <div class="no-result" v-if="filtered_products.data.length == 0">
                <fa :icon="['fas', 'search']" />
                <h2 class="mt-5">
