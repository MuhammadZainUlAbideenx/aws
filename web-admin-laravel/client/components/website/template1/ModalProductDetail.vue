          ...
          <div class="row g-0" v-if="product">
            ...
            <div class="col-12 col-md-6 pro-description">
              ...
              <div class="pro-sec price-sec">
                ...
                >
                  <h4 class="itm-price mb-0" v-if="is_variable">{{ price }}</h4>
                  <h4 class="itm-price mb-0" v-else>{{ price }}</h4>
                  <div
...
export default {
  ...
  mounted() {
    this.$root.$on("detailModalProductChanged", (data) => {
      ...
      else if(this.product.product_type == 2)
      {
          this.is_variable = true
           this.price = this.product.starting_from_price;
