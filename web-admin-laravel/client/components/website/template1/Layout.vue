<template>
  ...
  <div v-else class="layout main-site">
    ...
    <!-- <WebsiteTemplate1Navbar :themeData="themeData" @change_direction="changeThemeDirection" /> -->
...
<!-- move to top end-->
    ...
    <WebsiteTemplate1OffCanvas @changeDirection="changeDirection"
      ...
      <WebsiteTemplate1ModalProductDetail modal_id="product_detail_quickview" />
  </div>
</template>
  ...
  data(){
    return {
      ...
      themeData: {
        ...
        currentlyActiveHeaderLayout:"Layout1",
         currentlyActiveFooterLayout:"Layout1"
    }
  },
  components: {
    Loading
...
<style lang="scss">
 @import "~/assets/sass/template1.scss";
