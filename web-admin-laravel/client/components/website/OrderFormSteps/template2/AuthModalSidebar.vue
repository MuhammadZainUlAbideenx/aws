...
<div class="modal log-in-modal" id="DeleteItem24" tabindex="-1"  aria-labelledby="exampleModalLabel" aria-hidden="true" >
    <div class="modal-dialog modal-dialog-centered modal-sm">
    <div class="modal-content rounded">
      <div class="modal-body text-center px-5">
        <h3 class="text-uppercase fw-bold mb-4 fs-4">{{ this.$t("login_to_your_account") }}</h3>
        <form>
          <span
          ...
          <div class="btn-wrap d-md-flex justify-content-between align-items-center flex-column">
            <button  type="button" class="btn bg-warning rounded py-2 px-5 fw-bold text-uppercase mb-md-0 mb-3" @click="loginPassport" >
              {{this.$t('login.login')}}
            </button>
