<template>
  ...
  <div v-else class="payment-methods pt-4">
    <div
      class="payment-methods-form rounded p-4"
    >
      <form class="row g-3">
        <span
        ...
        >
          <h5 class="text-primary text-body mb-4">
              ...
              <div class="payment-det-form border-top pt-4">
                ...
                <div class="mb-3">
                  ...
                  <label for="card-number" class="form-label">{{
                    $t("web.customer.wallet.card_number")
                  }}</label>
                  <input
                    class="form-control"
        ...
        <!-- <div class="col-md-12 mt-4">
          <h5 class="text-primary text-body mb-4">{{$t('web.customer.orders.order_notes')}}</h5>
          <div class="mb-3">
            <textarea class="form-control" id="validationTextarea" :placeholder="$t('web.customer.orders.order_notes')" required>
