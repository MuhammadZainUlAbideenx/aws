<template>
  <div class="cart-summary bg-secondary p-4 mt-5 mt-100">
    ...
    <div class="cart-summary-widget px-3">
      <ul class="product-list" v-if="allCartItems">
        <li v-for="cart_item in allCartItems.cart_items" :key="cart_item.id">
          ...
          <div class="item-detail-wrap d-flex flex-grow-1 align-items-start">
      ...
      <ul class="product-detail-list">
        ...
        <li v-if="allCartItems.discount">
          <ul>
            <li>
              <h6>{{ this.$t("discount") }}</h6>
             <div class="item-s" v-if="allCartItems.currency_direction == 'rlt'">
