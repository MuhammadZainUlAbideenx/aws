<template>
  <div class="order-form-btns text-center d-flex flex-column px-5 py-4">
    <div class="">
    ...
    <a
      v-if="this.step == 5"
      class="btn bg-warning rounded py-3 lh-sm fw-bold text-uppercase mt-4 mx-3"
 ...
 {{$t('web.btn_order.proceed_payment')}}
    ...
    >
      <span class="d-lg-block d-none">{{$t('confirm_and_continue')}}</span>
      <span class="d-lg-none d-block">{{$t('confirm')}}</span>
    </a>
    <a
