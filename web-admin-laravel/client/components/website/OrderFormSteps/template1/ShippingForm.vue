<template>
  <div class="billing-adress pt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h5 class="text-primary text-uppercase fw-bold mb-0">{{$t('form.orders.shipping_address.label')}}</h5>
    </div>
      ...
      <form class="row g-3 needs-validation">
        ...
        <div class="col-lg-6">
          ...
          <input
            ...
            aria-describedby="input-live-help input-live-feedback"
            :placeholder="this.$t('form.customer.near_by.placeholder')"
            trim
          />
          <div id="validationServer06Feedback" class="invalid-feedback">
         {{$t('form.customer.valid_zip')}}
        ...
        <div class="col-md-12">
          ...
          <span
            class="float-end text-danger"
            v-if="shipping_address.address == '' || all_errors && all_errors['shipping_address.address']"
          >
            {{this.$t("must_be_valid_google_address")}}
          </span>
          <!-- <textarea
            class="form-control"
            :placeholder="this.$t('form.customer.address.placeholder')"
