        ...
        <div class="row g-0">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.slider_image.edit_slider_image") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              <ol class="breadcrumb float-sm-right text-body">
                ...
                <li class="breadcrumb-item">
                  <nuxt-link :to="localePath('/admin/slider_images')">{{ this.$t("sidebar.slider_image") }}</nuxt-link>
                </li>
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.slider_image.edit_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
            ...
            <div class="card  gutter-b  border-0" >
              <div class="card-body">
                <div class="row">
                  ...
                  <div role="group">
                    <label for="input-live" class="   form-label">{{ this.$t("form.slider_image.slider_type.label") }}:</label>
                    <span class="float-end text-danger"
                      ...
                      <v-select
                        class=""
                        :placeholder="this.$t('form.slider_images.slider_type.placeholder')"
              ...
              <div role="group">
                <label for="input-live" class="form-label">{{ this.$t("form.slider_image.url_type.label") }}:</label>
                <span class="float-end text-danger"
                  ...
                  <v-select
                    class=""
                    :placeholder="this.$t('form.slider_image.url_type.placeholder')"
                ...
                <div class="col-md-6 my-1 ps-md-0">
                  ...
                  <label class="label form-label">
                    ...
                    <span class="float-end text-danger"
                      ...
                      <datetime :placeholder="this.$t('form.slider_image.expiry_date.placeholder')" input-class="form-control"  value-zone="local" type="datetime" use12-hour v-model="formData.expiry_date"></datetime>
                 <span class="   heebo-light">
              ...
              <div class="col-md-6 my-1 pe-md-0">
                <div role="group">
                  <label for="input-live" class="px-2 form-label">{{ this.$t("form.slider_image.website_url.label") }}:</label>
                  <span class="float-end text-danger"
                  ...
                  <input :class="error && error.website_url ? 'error' : ''"
                         ...
                         :placeholder="this.$t('form.slider_image.website_url.placeholder')"
                         trim />
                 ...
                 <div class="col-md-6 my-1 ps-md-0">
                <div role="group">
                  <label for="input-live" class="px-2 form-label">{{ this.$t("form.slider_image.discount.label") }}:</label>
                  <span class="float-end text-danger"
                        v-if="error && error.discount">
                      {{ error.discount[0] }}
                    </span>
                  <input :class="error && error.discount ? 'error' : ''"
                         class="form-control"
                         aria-describedby="input-live-help input-live-feedback"
                         v-model="formData.discount"
                         :placeholder="this.$t('form.slider_image.discount.placeholder')"
                         trim />
                 <span class="px-2 heebo-light">
                           ...
                           <div class="tab-pane fade" :class="index == 0 ? 'active show':''" v-for="(language,index) in allActiveLanguages.languages" :key="language.code" :id="language.code" role="tabpanel" :aria-labelledby="language.code+'-tab'">
                              <div class="row">
                                <div class="col-md-6 my-1" >
                                  <div role="group ">
                                    <label for="input-live" class="   form-label">{{ $t("form.slider_image.image.label") }}:</label>
                                    <span class="float-end text-danger"
                                      ...
                                      <div >
                                        ...
                                        <button class="btn btn-primary px-3 py-2" type="button" name="button"  data-bs-toggle="modal" :data-bs-target="'#selectSliderImageMedia'+language.code">{{ $t("form.select_media") }}</button>
                                 ...
                                 <div class="col-md-6 my-1">
                                  <div role="group ">
                                    ...
                                    <input
                                      ...
                                      aria-describedby="input-live-help input-live-feedback"
                                      :placeholder="
                                        $t('form.slider_image.heading.placeholder')
                                      "
                                      trim
                                    />
                                    <span class="heebo-light">
                                ...
                                <div class="col-md-6 my-1">
                                  <div role="group ">
                                    ...
                                    <input
                                      ...
                                      aria-describedby="input-live-help input-live-feedback"
                                      :placeholder="
                                        $t('form.slider_image.button_text.placeholder')
                                      "
                                      trim
                                    />
                                    <span class="heebo-light">
                                      {{
                                        $t("form.slider_image.button_text.subheading")
                                      }}
                                    </span>
                                  </div>
                                </div>
...
<script >
  ...
  export default {
    ...
    meta: {
      permission: 'slider_images.update',
      strategy: 'update'
    },
    data() {
      return {
    ...
    async fetch() {
      ...
      const { data } = await this.$repositories.slider_images.show(this.$route.params.id)
      // get and update data
      this.formData.image = data.imageTranslations
      this.formData.name = data.nameTranslations
      this.formData.heading = data.headingTranslations
    ...
    methods: {
      ...mapActions({
        updateSliderImages: 'SliderImages/updateSliderImages',
