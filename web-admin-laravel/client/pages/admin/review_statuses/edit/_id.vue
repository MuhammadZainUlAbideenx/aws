        ...
        <div class="row g-0">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.review_status.edit_review_status") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.review_status.edit_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
...
export default {
  ...
  meta: {
    permission: "review_statuses.update",
    strategy: "update",
  },
  data() {
    return {
  ...
  methods: {
    ...mapActions({
      updateReviewStatuses: "ReviewStatuses/updateReviewStatuses",
    ...
    async updateAndContinue() {
          this.disabled=true
      await this.updateReviewStatuses({
