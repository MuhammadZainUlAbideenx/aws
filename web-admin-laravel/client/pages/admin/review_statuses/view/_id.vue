        ...
        <div class="row g-0">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("review_status.view_review_status") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.review_status.view_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
                    ...
                    <div class="show-table px-0">
                      ...
                      <div class="col-3">
                        <div class="form-switch">
                          <input
                            ...
                            :checked="review_status.is_active ? 'checked' : ''"
                            type="checkbox"
                      ...
                      <div class="col-3">
                        <div class="form-switch">
                          <input
                            class="form-check-input"
                            :checked="review_status.is_default ? 'checked' : ''"
                            type="checkbox"
                            id="flexSwitchCheckChecked"
                            disabled
                          />
                    ...
                    <div class="px-0 pt-3">
                      ...
                      <p>
                        <span class="heebo-light">
                          {{ $t("form.review_status.form_description") }}
                        </span>
                      </p>
                    </div>
                    <div class="d-md-flex">
                                    ...
                                    <div class="col-md-6 my-1">
                                      <div role="group ">
                                        <div role="group">
                                          ...
                                          >
                                            {{
                                              review_status.nameTranslations[
                                                language.code
                                              ]
                                            }}
                                          </div>
...
export default {
  ...
  async fetch() {
    const { data } = await this.$repositories.review_statuses.show(
