        ...
        <div class="row g-0">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.application_slider_image.create_new_application_slider_image") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.application_slider_image.form_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
                ...
                <div class="row">
                  ...
                  <div role="group">
                    ...
                    <span class="float-end text-danger"
                      ...
                      <v-select
                        class=""
                        :placeholder="this.$t('form.application_slider_image.slider_type.placeholder')"
                ...
                <div class="col-md-6 pe-md-0">
                  ...
                  <label class="label form-label">
                    ...
                    <span class="float-end text-danger"
                      ...
                      <datetime :placeholder="this.$t('form.application_slider_image.expiry_date.placeholder')" input-class="form-control"  type="datetime" value-zone="local" use12-hour v-model="formData.expiry_date"></datetime>
                 <span class="   heebo-light">
...
<script >
  ...
  export default {
    ...
    meta: {
      permission: 'application_slider_images.create',
      strategy: 'create'
    },
    async fetch(){
    ...
    methods: {
      ...mapActions({
        addApplicationSliderImages: 'ApplicationSliderImages/addApplicationSliderImages',
      ...
      async addAndContinue() {
        await this.addApplicationSliderImages(this.formData).then(res => {
          // some error occur
          if (res.response) {
            ...
            this.application_slider_image_image_path = ''
