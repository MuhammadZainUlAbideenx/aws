          ...
          <div class="row">
            <div class="col-sm-12 px-0">
              <ol class="breadcrumb float-sm-right text-body">
                ...
                <li class="breadcrumb-item">
                  <nuxt-link :to="localePath('/admin/units')">{{
                    this.$t("sidebar.unit")
                  }}</nuxt-link>
                </li>
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.unit.edit_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
          ...
          <div class="col-lg-12">
            <div class="card gutter-b border-0">
              <div class="card-body">
                <div class="row">
<div
                  class="col-md-6 my-1 d-flex justify-content-center flex-column ps-md-0"
                >
                  <div class="d-flex align-items-center">
                    <label class="label form-label me-4 text-capitalize">
                      {{ this.$t("form.unit.status.label") }}
                    </label>
                                ...
                                <div class="col-md-6 my-1">
                                  <div role="group ">
                                    ...
                                    <input
                                      ...
                                      :placeholder="
                                        $t('form.unit.name.placeholder')
                                      "
                                      trim
                                    />
                                    <span class="heebo-light">
                                      {{
                                        $t("form.unit.name.subheading")
                                      }}
                                    </span>
                                  </div>
                                </div>
                                ...
                                <div class="col-md-12 my-1">
                                  <div role="group ">
                                    ...
                                    <span class="px-2 heebo-light">
                                      {{
                                        $t(
                                          "form.unit.description.subheading"
                                        )
                                      }}
                                    </span>
                                  </div>
...
export default {
  ...
  async fetch() {
    const { data } = await this.$repositories.units.show(this.$route.params.id);
    // get and update data
  ...
  methods: {
    ...
    async update() {
      ...
      if (!this.error) {
        this.$router.replace(this.localePath("/admin/units"));
      }
    },
