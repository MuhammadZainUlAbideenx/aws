        ...
        <div class="row g-0">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.unit.create_new_unit") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.unit.form_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
...
export default {
  ...
  methods: {
    ...
    async addAndContinue() {
         this.disabled=true
      await this.addUnits(this.formData).then((res) => {
        // some error occur
        if (res.response) {
