        ...
        <div class="row g-0">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.contact_form.edit_contact_form") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.contact_form.edit_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
...
export default {
  ...
  meta: {
    permission: "contact_forms.update",
    strategy: "update",
  },
  data() {
    return {
  ...
  methods: {
    ...mapActions({
      updateContactForms: "ContactForms/updateContactForms",
