        ...
        <div class="row g-0">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.category.create_new_category") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.category.form_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-6 ps-md-0">
                    <div role="group">
                      ...
                      <span class="float-end text-danger"
                        ...
                        <AdminSearchSelectable :class="error && error.parent_id ? 'error' : ''" apiMethod="activeInactiveCategories" responseKey="categories"
                          :initialOptions="allActiveInactiveCategories.categories" :placeholder="$t('form.category.parent_category.placeholder')" v-model="formData.parent_id" v-on:input="checkParentId" />
                     <span class=" heebo-light">
                  ...
                  <div class="col-md-6  d-flex justify-content-center flex-column pe-md-0">
                    ...
                    <div class="col-md-6  d-flex justify-content-center flex-column ps-md-0 " v-if="this.enableFeatured">
                        <div class="d-flex align-items-center ">
                            <label class="label form-label me-4 text-capitalize">
  ...
  export default {
    ...
    methods: {
      ...
      async addAndContinue() {
        ...
        await this.addCategories(sendData).then(res => {
          // some error occur
          if (res.response) {
