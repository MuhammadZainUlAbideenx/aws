        ...
        <div class="row">
          <div class="col-sm-12 px-0">
            ...
            <p class="text-body-secondary">
              {{ this.$t("form.seo_page.index_description") }}
            </p>
          </div>
          <!-- /.col -->
        </div>
                ...
                <template slot="table-row" slot-scope="props">
                  <div v-if="props.column.field == 'actions'">
                    ...
                    <button
                      ...
                      :data-bs-target="'#DeleteItem' + props.row.seo.id"
                    >
                      <fa :icon="['fas', 'trash-alt']" fixed-width />
                    </button>
                    <AdminDeleteModal
                      :modal_id="'DeleteItem' + props.row.seo.id"
                      @deleteClicked="deleteSeoPage(props.row.seo.id)"
                      :delete_id="props.row.seo.id"
                    >
                    </AdminDeleteModal>
                  </div>
                  <span v-else>
...
export default {
  ...
  watch: {
    allSeoPages(newCount, oldCount) {
      if (
        this.allSeoPages &&
        this.allSeoPages != null &&
        this.allSeoPages.data != null
      ) {
