        ...
        <div class="row g-0">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.attribute.edit_attribute") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.attribute.edit_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
...
export default {
  ...
  async fetch() {
    const { data } = await this.$repositories.attributes.show(this.$route.params.id);
    // get and update data
  ...
  methods: {
    ...mapActions({
      updateAttributes: "Attributes/updateAttributes",
