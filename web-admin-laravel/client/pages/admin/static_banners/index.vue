        ...
        <div class="row">
          <div class="col-sm-12 px-0">
            ...
            <p class="text-body-secondary">
              {{ this.$t("form.static_banner.index_description") }}
            </p>
          </div>
          <!-- /.col -->
        </div>
              ...
              >
                <template slot="table-row" slot-scope="props">
                  ...
                  <div v-else-if="props.column.field == 'is_active'">
                    <div class="form-switch">
                      <input
                        ...
                        @change="
                          (event) =>
                            changeStaticBannerStatus(props.row.id, event)
                        "
                  ...
                  <div v-else-if="props.column.field == 'type'">
                    <span v-if="props.row.type == 'home_page'">{{$t('form.static_banner.type.type_1')}}</span>
                    <span v-if="props.row.type == 'shop_page'">{{$t('form.static_banner.type.type_2')}}</span>
                    <span v-if="props.row.type == 'categories_dropdown'"
                      >{{$t('form.static_banner.type.type_3')}}</span
                    >
                  </div>

                  <div v-else-if="props.column.field == 'actions'">
                    <nuxt-link
                      v-permission="'static_banners.index'"
                    ...
                    <nuxt-link
                      v-permission="'static_banners.update'"
                    ...
                    <AdminDeleteModal
                      ...
                      @deleteClicked="deleteStaticBanner(props.row.id)"
...
export default {
  ...
  watch: {
    allStaticBanners(newCount, oldCount) {
      if (
        this.allStaticBanners &&
        this.allStaticBanners != null &&
        this.allStaticBanners.data != null
      ) {
