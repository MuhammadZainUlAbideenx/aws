      ...
      <div class="row g-0 mb-2">
        <div class="col-sm-12 px-0">
          <h2 class="m-0 text-body bold">
            {{ this.$t("form.order_status.view_order_status") }}
          </h2>
        </div>
        <!-- /.col -->
        <div class="row">
                  ...
                  <div class="col-md-12 my-1 px-0">
                    <div class="show-table mb-0">
                      <div class="row justify-content-end">
                        ...
                        <div class="col-2">
                          <div class="form-switch">
                            <input
                              ...
                              :checked="
                                order_statuses.is_default ? 'checked' : ''
                              "
                              type="checkbox"
                        ...
                        <div class="col-2">
                          <div class="form-switch">
                            <input
                              class="form-check-input"
                              :checked="
                                order_statuses.is_active ? 'checked' : ''
                              "
                              type="checkbox"
                              id="flexSwitchCheckChecked"
                            />
                        ...
                        <div class="col-2">
                          <div class="form-switch">
                            <p>{{ order_statuses.status_code }}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                                      ...
                                      <div role="group ">
                                        <div role="group">
                                          <label for="input-live form-label">{{
                                            $t("form.order_statuses.name.label")
                                          }}</label>
                                          <div
                                            class="
                                              py-3
                                          ...
                                          >
                                            {{
                                              order_statuses.nameTranslations[
                                                language.code
                                              ]
                                            }}
                                          </div>
                                    ...
                                    <div class="col-md-12 my-1">
                                      <div role="group ">
                                        <div role="group">
                                          <label for="input-live form-label">{{
                                            $t(
                                              "form.order_statuses.description.label"
                                            )
                                          }}</label>
                                          <div
                                            class="
