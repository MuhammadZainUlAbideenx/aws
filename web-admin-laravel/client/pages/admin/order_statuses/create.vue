        ...
        <div class="row g-0">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.order_status.create_new_order_status") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.order_status.form_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
                  ...
                  <div class="col-md-3 my-1">
                    ...
                    <div role="group">
                      <label for="input-live" class="form-label"
                        >{{ this.$t("form.order_status.status_code.label") }}:</label
                      >
                      <span
                      ...
                      <input
                        ...
                        :placeholder="this.$t('form.order_status.status_code.placeholder')"
                        trim
                      />
                      <span class="heebo-light">
                                ...
                                <div class="col-md-12 my-1">
                                  <div role="group ">
                                    <label
                                      ...
                                      >{{
                                        $t(
                                          "form.order_status.description.label"
                                        )
                                      }}:</label
                                    >
                                    <span
...
export default {
  ...
  meta: {
    permission: "order_statuses.create",
    strategy: "create",
  },
  fetch() {},
  data() {
  ...
  methods: {
    ...mapActions({
      addOrderStatuses: "OrderStatuses/addOrderStatuses",
    ...
    async addAndContinue() {
         this.disabled=true
      await this.addOrderStatuses(this.formData).then((res) => {
        // some error occur
        if (res.response) {
