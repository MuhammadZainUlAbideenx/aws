            ...
            >
              ...
              <div class="col-lg-4 table-actions px-0">
                <div slot="table-actions" class="align-middle">
                  ...
                  <nuxt-link
                  v-permission="'riders.create'"
                  :to="localePath('/admin/riders/create')">
                    <button
                      type="button"
...
export default {
  ...
  async fetch() {
       if (this.$gates.hasPermission('riders.index')) {
  ...
  methods: {
    ...mapActions({
      fetchRiders: "Riders/fetchRiders",
      fetchActiveRiders: "General/fetchActiveRiders",
      deleteRiders: "Riders/deleteRiders",
      filterRiders: "Riders/filterRiders",
      updateRiderStatus: "Riders/updateRiderStatus",
      updateRiderIsDefault: "Riders/updateRiderIsDefault",
    }),
    async exportRiders(type) {
      this.filterData.export = type;
      await this.$repositories.riders.export(this.filterData);
    },
