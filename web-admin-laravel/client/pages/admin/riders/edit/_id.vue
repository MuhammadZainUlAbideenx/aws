        ...
        <div class="row">
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right text-body">
              ...
              <li class="breadcrumb-item">
                <nuxt-link :to="localePath('/admin/riders')">{{
...
export default {
  ...
  async fetch() {
    ...
    const { data } = await this.$repositories.riders.show(
    ...
    this.formData.vendor_id = data.vendor.name;
    if (data.country) {
  ...
  methods: {
    ...mapActions({
      updateRiders: "Riders/updateRiders",
    ...
    async update() {
      ...
      if (!this.error) {
        this.$router.replace(this.localePath("/admin/riders"));
      }
    },
  ...
  computed: {
    now: function () {
      ...
      max_date.setYear(max_date.getFullYear());
