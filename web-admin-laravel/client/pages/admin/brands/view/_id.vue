          ...
          <div class="row">
            <div class="col-sm-12 px-0">
              <ol class="breadcrumb float-sm-right text-body">
                ...
                <li class="breadcrumb-item">
                  <nuxt-link :to="localePath('/admin/brands')">{{
                    this.$t("sidebar.brand")
                  }}</nuxt-link>
                </li>
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.brand.view_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
            ...
            <div class="card gutter-b border-0">
              <div class="card-body">
                    ...
                    <div role="group">
                      ...
                      <div class="py-2">
                        <img
                          ...
                          v-bind:src="
                            url + `${brand.image.original_media_path}`
                          "
                        />
                      </div>
                    </div>
                ...
                <div class="row justify-content-end">
                  <div class="col-6">
                      <label for="input-live form-label">{{
                        this.$t("form.brand.website_url.label")
                      }}</label>
                  </div>
                  <div class="col-6"><p>{{ brand.website_url }}</p></div>
                  <div class="col-6">
                  ...
                  <div class="col-6">  <div class="form-switch">
                          <input
                            ...
                            :checked="brand.is_featured ? 'checked' : ''"
                            type="checkbox"
...
export default {
  ...
  async fetch() {
    const { data } = await this.$repositories.brands.show(
