          ...
          <div class="row">
            <div class="col-sm-12 px-0">
              ...
              <p class="text-body-secondary mb-0">
                {{ this.$t("form.brand.edit_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
      ...
      <div class="container" v-else>
        <div class="col-lg-12">
          ...
          <div class="row">
                ...
                <div class="row">
              <div class="col-md-6  d-flex justify-content-center flex-column ps-md-0">
              ...
              <div class="col-md-6  d-flex justify-content-center flex-column pe-md-0">
                      <div class="d-flex align-items-center ">
                          <label class="label form-label me-4 text-capitalize">
                        ...
                        <div class="tab-content p-4" id="myTabContent">
                          <div class="tab-pane fade" :class="index == 0 ? 'active show':''" :key="language.code" v-for="(language,index) in allActiveLanguages.languages" :id="language.code" role="tabpanel" :aria-labelledby="language.code+'-tab'">
                              <div class="row">
                                <div class="col-md-6" >
                                  <div role="group ">
                                    <label for="input-live" class=" form-label">{{ $t("form.brand.name.label") }}:</label>
                                    <span class="float-end text-danger"
                                    ...
                                    <input class="form-control"
                                           ...
                                           aria-describedby="input-live-help input-live-feedback"
                                           :placeholder="$t('form.brand.name.placeholder')"
                                           trim />
                                    <span class=" heebo-light">
                              ...
                              <div class="row">
                                <div class="col-md-12 my-1" >
                                  <div role="group ">
                                    <label for="input-live" class=" form-label">{{ $t("form.brand.description.label") }}:</label>
                                    <span class="float-end text-danger"
                                    ...
                                    <span class=" heebo-light">
                                        {{ $t("form.brand.description.subheading") }}
                                      </span>
                                  </div>
                                </div>
                              </div>
...
<script >
  ...
  export default {
    ...
    async fetch() {
      ...
      const { data } = await this.$repositories.brands.show(this.$route.params.id)
      // get and update data
      ...
      if(data.image){
        ...
        if(data.image.thumbnails){
          this.brand_image_path = data.image.thumbnails.small.thumbnail
        }
      }
    ...
    methods: {
      ...mapActions({
        updateBrands: 'Brands/updateBrands',
