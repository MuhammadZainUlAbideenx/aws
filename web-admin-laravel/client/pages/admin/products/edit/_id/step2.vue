                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                <div
                                                    class="barIconBg position-absolute d-flex align-items-center justify-content-center"
                                                >
                                                    <span
                                        ...
                                        <div
                                            class="text-dark order-head fw-bold float-end product-step-name"
                                        >
                                            {{$t('product_info')}}
                                        </div>
                                    </li>
                                        ...
                                        <div class="mx-5">
                                            <div class="d-grid">
                                                ...
                                                >
                                                    {{
                                                        $t(
                                                            "form.If_you_want_to_choose_image"
                                                        )
                                                    }}
                                    ...
                                    <div class="col-md-12 px-0">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    <div
                                                        class="co1-12 d-flex align-items-center justify-content-between"
                                                    >
                                                        <p class="fw-bold">
                                                            {{
                                                                $t(
                                                                    "form.product.product_media.sort_order"
                                                                )
                                                            }}
                                                            :
                                                            {{
...
export default {
    ...
    methods: {
        ...mapActions({
            updateProductMedia: "Products/updateProductMedia",
