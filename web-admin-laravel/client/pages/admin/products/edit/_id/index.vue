            ...
            <div class="card gutter-b border-0">
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 my-1 pe-md-0">
                    <div role="group">
                      ...
                      <AdminSearchSelectable
                        ...
                        "
                        :selectedOptions="selected_manufacturer"
                  ...
                  >
                    <div role="group">
                      ...
                      <AdminSearchSelectable
                        ...
                        :placeholder="
                          this.$t('form.coupon.vendor.placeholder')
                        "
                  ...
                  <div class="col-md-6 mb-3 pe-md-0" v-if="formData.product_type != 2">
                    <div role="group">
                      <label for="input-live" class="form-label"
                ...
                <div class="row">
                  <div class="col-md-6 my-1 ps-md-0" v-if="formData.product_type != 2">
                    <div role="group">
                      <label for="input-live" class="form-label"
                        >{{
                      ...
                      <div class="input-group">
                        <span class="input-group-text mb-3">
                          {{
                            allActiveSettings.settings.current_currency
                          }}</span
                        >
                        <input
                  ...
                  <div class="col-md-6 my-1 pe-md-0" v-if="formData.product_type != 2">
                    <div role="group">
                      <label for="input-live" class="form-label"
                        >{{
                ...
                <div class="col-md-6 my-1 ps-md-0">
                  <div role="group">
                    <label for="input-live" class="form-label"
                      >{{
                        this.$t("form.product.related_products.label")
                      }}:</label
                    >
                    <span
                      class="float-end text-danger"
                    ...
                    <AdminSearchSelectable
                      ...
                      :placeholder="
                        this.$t('form.product.related_products.placeholder')
                      "
                      :selectedOptions="selected_related_products"
                      v-model="formData.related_products"
                    />
                    <span class="heebo-light">
                      {{ $t("form.product.related_products.subheading") }}
                    </span>
                  </div>
                </div>
...
export default {
  ...
  async fetch() {
    if (this.allActiveSettings.settings.generalSettings.is_multi_vendor == '0') {
    ...
    // this.categories = data.categories_res;
    ...
    if (data.vendor) {
    // If store is multivendor

      this.selected_vendor = data.vendor;
      this.formData.vendor_id = data.vendor.id;

    }
    if (this.allActiveSettings.settings.generalSettings.is_multi_vendor == '1') {
    ...
    if (data.flash_sale) {
      ...
      this.formData.flash_sale.start_date = data.flash_sale.start_date_edit;

      this.formData.flash_sale.expire_date = data.flash_sale.expire_date_edit;
  ...
  methods: {
    ...
    async updateAndNext() {
      ...
      if (!this.error) {
        this.$router.replace(
          this.localePath(
            "/admin/products/edit/" + this.$route.params.id + "/step2"
          )
        );
      }
    },
    async update() {
      await this.updateAndContinue();
      if (!this.error) {
        this.$router.replace(this.localePath("/admin/products"));
      }
    },
