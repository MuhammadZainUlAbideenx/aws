          ...
          <div class="col-lg-12">
            <div class="card gutter-b border-0">
              <div class="card-body p-4">
                ...
                <ul
                  class="nav nav-pills order-profile-tabs my-4 mb-5 pb-4"
                  id="pills-tab"
                  role="tablist"
                ...
                >
                  ...
                  <!-- <li class="nav-item col-md-4 col-12 mb-md-0 mb-4" role="presentation">
                                        <button class="w-100 p-md-0 pe-none" id="pills-profile-tab"
                                            data-bs-toggle="pill" data-bs-target="#pills-profile" type="button"
                                            role="tab" aria-controls="pills-profile" aria-selected="false">
                                            <div class="product-border-top-nav position-relative mb-3"></div>
                                        </button>
                                    </li> -->
                </ul>
                ...
                >
                  ...
                  <!-- <li class="nav-item col-md-3 col-12 mb-md-0 mb-4" role="presentation">
                                        <button class="w-100 p-md-0 pe-none active" id="pills-profile-tab"
                                            data-bs-toggle="pill" data-bs-target="#pills-profile" type="button"
                                            role="tab" aria-controls="pills-profile" aria-selected="false">
                                            <div class="product-border-top-nav position-relative mb-3"></div>
                                        </button>
                ...
                <div class="row">
                          ...
                          <div class="card-header bg-light p-4">
                            ...
                            >
                              ...
                              <div>
                                ...
                                <button
                                  v-if="
                                    formData.attributes[att_index].values
                                      .length == 0
                                  "
                                  type="button"
                                  @click="addValue(attribute.id)"
                                  class="btn text-success p-0 rounded-circle"
                                  name="button"
                                >
                        ...
                        >
                          ...
                          <td>
                            <div class="input-group">
                              ...
                              <input
                                ...
                                :class="
                                  error &&
                                  error['combinations.' + index + '.price']
                                    ? 'error'
                                    : ''
                                "
                                ...
                                :placeholder="
                                  $t(
                                    'form.product_attributes.price.placeholder'
                                  )
                                "
                                trim
                              />
                            ...
                            <span
                              class="float-end text-danger p-0 fs-6"
                              v-if="
                          ...
                          <td>
                            <input
                              ...
                              :class="
                                error &&
                                error['combinations.' + index + '.stock']
                                  ? 'error'
                                  : ''
                              "
                  ...
                  <div class="row" v-permission="'products.update'">
...
export default {
  ...
  methods: {
    ...mapActions({
      updateProductAttribute: "Products/updateProductAttribute",
      addProductAttribute: "Products/addProductAttribute",
    ...
    addAttribute(e, a) {
      ...
      if (attr != -1) {
        this.$toast.success(this.$t('attribute_already_exist'));
      } else {
        const obj = {
          id: e,
          name: a.name,
    ...
    async update() {
      ...
      for (let index = 0; index < this.formData.attributes.length; index++) {
        ...
        if (element.values.length == 0) {
          this.$toast.error($t('attribute_values_cannot_be_empty'));
          this.disabled = false;
          return false;
        }
      }
