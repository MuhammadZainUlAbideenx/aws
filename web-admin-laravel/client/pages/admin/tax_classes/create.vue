        ...
        <div class="row g-0">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.tax_class.create_new_tax_class") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.tax_class.form_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
...
// import CkeditorNuxt from "@/components/global/ckeditorNuxt";
  ...
  export default {
    ...
    methods: {
      ...mapActions({
        addTaxClasses: 'TaxClasses/addTaxClasses',
      ...
      async addAndContinue() {
        await this.addTaxClasses(this.formData).then(res => {
          // some error occur
          if (res.response) {
