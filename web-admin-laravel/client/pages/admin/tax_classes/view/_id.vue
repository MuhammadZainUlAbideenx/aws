        ...
        <div class="row g-0">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.tax_class.view_tax_class") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.tax_class.view_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
                        ...
                        <div class="col-6">
                           <div class="form-switch">
                            <input
                              ...
                              :checked="tax_class.is_active ? 'checked' : ''"
                              type="checkbox"
                    ...
                    <div class="px-0 pt-3">
                      ...
                      <p>
                        <span class="heebo-light">
                          {{ $t("form.tax_class.form_description") }}
                        </span>
                      </p>
                    </div>
                    <div class="d-md-flex">
