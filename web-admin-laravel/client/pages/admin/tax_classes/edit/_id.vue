        ...
        <div class="row g-0">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.tax_class.edit_tax_class") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              <ol class="breadcrumb float-sm-right text-body">
                ...
                <li class="breadcrumb-item">
                  <nuxt-link :to="localePath('/admin/tax_classes')">{{ this.$t("sidebar.tax_class") }}</nuxt-link>
                </li>
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.tax_class.edit_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
                  ...
                  <div class="col-md-6 my-1 ps-md-0 d-flex justify-content-center flex-column ">
                      <div class="d-flex align-items-center ">
                          <label class="label form-label me-4 text-capitalize">
                            {{ this.$t("form.tax_class.status.label") }}
                          </label>
                        ...
                        <span class=" heebo-light">
                          {{ $t("form.tax_class.status.subheading") }}
                        </span>
                  </div>
                </div>
                                ...
                                <div class="col-md-6 my-1">
                                  <div role="group ">
                                    ...
                                    <input
                                      ...
                                      :placeholder="
                                        $t('form.tax_class.name.placeholder')
                                      "
                                      trim
                                    />
                                    <span class="heebo-light">
                                      {{
                                        $t("form.tax_class.name.subheading")
                                      }}
                                    </span>
                                  </div>
                                </div>
                                ...
                                <div class="col-md-12 my-1">
                                  <div role="group ">
                                    <label
                                      ...
                                      >{{
                                        $t(
                                          "form.tax_class.description.label"
                                        )
                                      }}:</label
                                    >
                                    <span
                                    ...
                                    <span class="px-2 heebo-light">
                                      {{
                                        $t(
                                          "form.tax_class.description.subheading"
                                        )
                                      }}
                                    </span>
                                  </div>
...
<script >
  ...
  export default {
    ...
    async fetch() {
      const { data } = await this.$repositories.tax_classes.show(this.$route.params.id)
      // get and update data
    ...
    methods: {
      ...mapActions({
        updateTaxClasses: 'TaxClasses/updateTaxClasses',
      ...
      async update() {
        ...
        if (!this.error) {
          this.$router.replace(this.localePath('/admin/tax_classes'))
        }
      },
      async updateAndContinue() {
        await this.updateTaxClasses({
