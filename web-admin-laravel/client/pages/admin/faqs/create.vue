        ...
        <div class="row g-0">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.faqs.create_new_faq") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.faqs.form_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
                    ...
                    <div role="group ">
                      ...
                      <span class="  heebo-light">
                          {{ $t("form.review.product.subheading") }}
                                  ...
                                  <div class="col-md-6 my-1 pe-md-0 px-4 d-flex justify-content-center flex-column">
