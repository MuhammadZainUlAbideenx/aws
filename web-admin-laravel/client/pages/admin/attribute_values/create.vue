      ...
      <div class="row g-0">
        <div class="col-sm-12 px-0">
          <h2 class="m-0 text-body bold">
            {{ this.$t("form.attribute_value.create_new_attribute_value") }}
          </h2>
        </div>
        <!-- /.col -->
        <div class="row">
          <div class="col-sm-12 px-0">
            <ol class="breadcrumb float-sm-right text-body">
              ...
              <li class="breadcrumb-item">
                <nuxt-link :to="localePath('/admin/attribute_value')">{{
            ...
            <p class="text-body-secondary">
              {{ this.$t("form.attribute_value.form_description") }}
            </p>
          </div>
          <!-- /.col -->
        </div>
                                ...
                                <div class="col-md-6 my-1">
                                  <div role="group ">
                                    ...
                                    <input
                                      ...
                                      :placeholder="
                                        $t(
                                          'form.attribute_value.name.placeholder'
                                        )
                                      "
                                      trim
                                    />
                                    <span class="heebo-light">
                                      {{
                                        $t(
                                          "form.attribute_value.name.subheading"
                                        )
                                      }}
                                    </span>
                                  </div>
...
export default {
  ...
  meta: {
    permission: "attribute_values.create",
    strategy: "create",
  },
  data() {
    return {
  ...
  methods: {
    ...mapActions({
      addAttributeValues: "AttributeValues/addAttributeValues",
    ...
    async addAndContinue() {
      this.disabled = true;
      await this.addAttributeValues(this.formData).then((res) => {
        // some error occur
        if (res.response) {
