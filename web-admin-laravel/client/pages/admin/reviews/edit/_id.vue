          ...
          <div class="row">
            <div class="col-sm-12 px-0">
              <ol class="breadcrumb float-sm-right text-body">
                ...
                <li class="breadcrumb-item">
                  <nuxt-link :to="localePath('/admin/reviews')">{{ this.$t("sidebar.review") }}</nuxt-link>
                </li>
                    ...
                    <div role="group ">
                      ...
                      <span class="float-end text-danger"
                        ...
                        <AdminSearchSelectable :class="error && error.customer_id ? 'error' : ''" apiMethod="activeCustomers" responseKey="customers"
                          :initialOptions="allActiveCustomers.customers" :selectedOptions="selected_customer" :placeholder="$t('form.review.customer.placeholder')" v-model="formData.customer_id" />
...
<script >
  ...
  export default {
    ...
    async fetch() {
      ...
      const { data } = await this.$repositories.reviews.show(this.$route.params.id)
