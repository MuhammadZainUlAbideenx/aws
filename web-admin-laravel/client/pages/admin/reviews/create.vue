      ...
      <div class="row g-0">
        <div class="col-sm-12 px-0">
          <h2 class="m-0 text-body bold">
            {{ this.$t("form.review.create_new_review") }}
          </h2>
        </div>
        <!-- /.col -->
        <div class="row">
          <div class="col-sm-12 px-0">
            ...
            <p class="text-body-secondary">
              {{ this.$t("form.review.form_description") }}
            </p>
          </div>
          <!-- /.col -->
        </div>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6 my-1 ps-md-0">
                    <div role="group ">
                      <label for="input-live" class="form-label"
                        >{{ $t("form.review.customer.label") }}:</label
                      >
                      <span
                      ...
                      <AdminSearchSelectable
                        :class="error && error.customer_id ? 'error' : ''"
                        apiMethod="activeCustomers"
                        responseKey="customers"
                        :initialOptions="allActiveCustomers.customers"
                        :placeholder="$t('form.review.customer.placeholder')"
                  ...
                  <div class="col-md-6 my-1 pe-md-0">
                    <div role="group ">
                      <label for="input-live" class="form-label"
                        >{{ $t("form.review.product.label") }}:</label
                      >
                      <span
                        class="float-end text-danger"
                      ...
                      <AdminSearchSelectable
                        ...
                        :placeholder="$t('form.review.product.placeholder')"
                  ...
                  <div class="col-md-6 my-1 ps-md-0">
                    <div role="group ">
                      <label for="input-live" class="form-label"
                        >{{ $t("form.review.set_status.label") }}:</label
                      >
                      <span
                        class="float-end text-danger"
                      ...
                      <AdminSearchSelectable
                        :class="error && error.review_status_id ? 'error' : ''"
                        apiMethod="activeReviewStatuses"
                        responseKey="review_statuses"
                        :initialOptions="
                          allActiveReviewStatuses.review_statuses
                        "
                        :placeholder="$t('form.review.set_status.placeholder')"
                        v-model="formData.review_status_id"
                      />
                      <span class="heebo-light">
                        {{ $t("form.review.customer.subheading") }}
                      </span>
                  ...
                  <div class="col-md-6 my-1 pe-md-0">
                    <div role="group">
                      <label for="input-live" class="form-label"
                        >{{ this.$t("form.review.description.label") }}:</label
                      >
                      <span
                        class="float-end text-danger"
                      ...
                      <textarea
                        class="form-control"
                        :placeholder="
                          this.$t('form.review.description.placeholder')
                        "
                  ...
                  <div class="col-md-6 my-1 ps-md-0">
                    <div role="group">
                      <label for="input-live" class="form-label"
                        >{{ this.$t("form.review.rating.label") }}:</label
                      >
                      <span
                        class="float-end text-danger"
                      ...
                      <input
                        :class="error && error.rating ? 'error' : ''"
                        class="form-control"
                        type="number"
                        maxlength="5.0"
                        minlength="0.0"
...
export default {
  ...
  async fetch() {
    ...
    if (!this.allActiveReviewStatuses.review_statuses) {
  ...
  methods: {
    ...
    async add() {
      ...
      if (!this.error) {
        this.$router.replace(this.localePath("/admin/reviews"));
      }
    },
    async addAndContinue() {
      this.disabled = true;
      await this.addReviews(this.formData).then((res) => {
        // some error occur
        if (res.response) {
