        ...
        <div class="row g-0">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.parallax_banner.create_new_parallax_banner") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.parallax_banner.form_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
...
<script >
  ...
  export default {
    ...
    meta: {
      permission: 'parallax_banners.create',
      strategy: 'create'
    },
    async fetch(){
    ...
    methods: {
      ...mapActions({
        addParallaxBanners: 'ParallaxBanners/addParallaxBanners',
      ...
      async addAndContinue() {
        await this.addParallaxBanners(this.formData).then(res => {
          // some error occur
          if (res.response) {
