        ...
        <div class="row g-0">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.content_page.create_new_content_page") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.content_page.form_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
...
export default {
  ...
  meta: {
    permission: "content_pages.create",
    strategy: "create",
  },
 fetch() {
  ...
  methods: {
    ...mapActions({
      addContentPages: "ContentPages/addContentPages",
    ...
    async addAndContinue() {
      await this.addContentPages(this.formData).then((res) => {
        // some error occur
        if (res.response) {
