        ...
        <div class="row g-0">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.content_page.edit_content_page") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              <ol class="breadcrumb float-sm-right text-body">
                ...
                <li class="breadcrumb-item">
                  <nuxt-link :to="localePath('/admin/content_pages')">{{
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.content_page.edit_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
                  ...
                  <div class="col-md-6 my-1 ps-md-0">
                    <div role="group">
                      <label for="input-live" class="px-2 form-label"
                        >{{
                          this.$t("form.content_page.slug.label")
                        }}:</label
                      >
                      <span
                      ...
                      <input
                        ...
                        :placeholder="
                          this.$t('form.content_page.slug.placeholder')
                        "
                        trim
                      />
                      <span class="px-2 heebo-light">
                        {{ $t("form.content_page.slug.subheading") }}
                      </span>
                    </div>
                  </div>
                  <div class="col-md-6 my-1 ps-md-0">
                    <div role="group">
                      <label class="label form-label me-4 text-capitalize">
                        {{ this.$t("form.content_page.status.label") }}
                      </label>
                      ...
                      <span class="heebo-light">
                        {{ $t("form.content_page.status.subheading") }}
                      </span>
                    </div>
                  </div>
                </div>
                              ...
                              <div class="col-md-6 my-1">
                                <div role="group ">
                                  <label for="input-live" class="form-label"
                                    >{{
                                      $t("form.content_page.name.label")
                                    }}:</label
                                  >
                                  <span
                                    class="float-end text-danger"
                                  ...
                                  <input
                                    ...
                                    aria-describedby="input-live-help input-live-feedback"
                                    :placeholder="
                                      $t('form.content_page.name.placeholder')
                                    "
                                    trim
                                  />
                                  <span class="heebo-light">
                                    {{
                                      $t("form.content_page.name.subheading")
                                    }}
                                  </span>
                                </div>
                              </div>
                              ...
                              <div class="col-md-12 my-1">
                                <div role="group ">
                                  <label
                                    ...
                                    >{{
                                      $t("form.content_page.description.label")
                                    }}:</label
                                  >
                                  <span
                                    class="float-end text-danger"
                                  ...
                                  <span class="px-2 heebo-light">
                                    {{
                                      $t(
                                        "form.content_page.description.subheading"
                                      )
                                    }}
                                  </span>
                                </div>
...
export default {
  ...
  meta: {
    permission: "content_pages.update",
    strategy: "update",
  },
  data() {
    return {
  ...
  async fetch() {
    ...
    const { data } = await this.$repositories.content_pages.show(
  ...
  methods: {
    ...mapActions({
      updateContentPages: "ContentPages/updateContentPages",
      fetchActiveContentPages: "General/fetchActiveContentPages",
    }),
    async update() {
      await this.updateAndContinue();
      if (!this.error) {
        this.$router.replace(this.localePath("/admin/content_pages"));
      }
    },
    async updateAndContinue() {
      await this.updateContentPages({
