        ...
        <div class="row">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.application_parallax_banner.create_new_application_parallax_banner") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              <ol class="breadcrumb float-sm-right text-body">
                ...
                <li class="breadcrumb-item">
                  <nuxt-link :to="localePath('/admin/application_parallax_banners')">{{
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.application_parallax_banner.form_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
      ...
      <div class="container" v-else>
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="row">
              <div class="col-md-12 px-4 text-end text-md-end">
                <button
                  type="button"
                  class="btn btn-primary mb-3 px-3 py-2"
                  @click="add"
...
export default {
  ...
  meta: {
    permission: "application_parallax_banners.create",
    strategy: "create",
  },
  async fetch() {
  ...
  methods: {
    ...mapActions({
      addApplicationParallaxBanners: "ApplicationParallaxBanners/addApplicationParallaxBanners",
    ...
    async addAndContinue() {
      await this.addApplicationParallaxBanners(this.formData).then((res) => {
        // some error occur
        if (res.response) {
          ...
          this.application_parallax_banner_image_path = "";
