        ...
        <div class="row g-0">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.application_banner.edit_application_banner") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              <ol class="breadcrumb float-sm-right text-body">
                ...
                <li class="breadcrumb-item">
                  <nuxt-link :to="localePath('/admin/application_banners')">{{ this.$t("sidebar.application_banner") }}</nuxt-link>
                </li>
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.application_banner.edit_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
                  ...
                  <div class="col-md-6 ps-md-0">
                    <div role="group">
                      <label class="label form-label">
                        {{ this.$t("form.application_banner.expiry_date.label") }}
                      </label>
                      <span
                      ...
                      <datetime
                        :placeholder="
                          this.$t('form.application_banner.expiry_date.placeholder')
                        "
                      ...
                      <span class="heebo-light">
                        {{ $t("form.application_banner.expiry_date.subheading") }}
                      </span>
                    </div>
                  </div>
                  <div class="col-md-6 pe-md-0">
                    <div role="group">
                      <label for="input-live" class="form-label"
                        >{{
                          this.$t("form.application_banner.website_url.label")
                        }}:</label
                      >
                      <span
                        class="float-end text-danger"
                      ...
                      <input
                        ...
                        :placeholder="
                          this.$t('form.application_banner.website_url.placeholder')
                        "
                        trim
                      />
                      <span class="heebo-light">
                        {{ $t("form.application_banner.website_url.subheading") }}
                      </span>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-6 ps-md-0 d-flex justify-content-center flex-column ">
                      <div class="d-flex align-items-center ">
                          <label class="label form-label me-4 text-capitalize">
                            {{ this.$t("form.application_banner.status.label") }}
                          </label>
                      ...
                      <span class=" heebo-light">
                         {{ $t("form.application_banner.status.subheading") }}
                        </span>
                    </div>
                </div>
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <div role="group ">
                                    <label for="input-live" class="form-label"
                                      >{{
                                        $t("form.application_banner.image.label")
                                      }}:</label
                                    >
                                    <span
                                      class="float-end text-danger"
                                    ...
                                    <span class="heebo-light">
                                      {{
                                        $t(
                                          "form.application_banner.image.subheading"
                                        )
                                      }}
                                    </span>
                                  </div>
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <div role="group ">
                                    <label for="input-live" class="form-label"
                                      >{{
                                        $t("form.application_banner.name.label")
                                      }}:</label
                                    >
                                    <span
                                      class="float-end text-danger"
                                    ...
                                    <input
                                      ...
                                      :placeholder="
                                        $t(
                                          'form.application_banner.name.placeholder'
                                        )
                                      "
                                      trim
                                    />
                                    <span class="heebo-light">
                                      {{
                                        $t("form.application_banner.name.subheading")
                                      }}
                                    </span>
                                  </div>
                                </div>
                                ...
                                <div class="col-md-12 my-1">
                                  <div role="group ">
                                    <label for="input-live" class="form-label"
                                      >{{
                                        $t(
                                          "form.application_banner.description.label"
                                        )
                                      }}:</label
                                    >
                                    <span
                                    ...
                                    <span class="heebo-light">
                                      {{
                                        $t(
                                          "form.application_banner.description.subheading"
                                        )
                                      }}
                                    </span>
                                  </div>
...
<script >
  ...
  export default {
    ...
    meta: {
      permission: 'application_banners.update',
      strategy: 'update'
    },
    data() {
      return {
    ...
    async fetch() {
      ...
      const { data } = await this.$repositories.application_banners.show(this.$route.params.id)
      // get and update data
    ...
    methods: {
      ...mapActions({
        updateApplicationBanners: 'ApplicationBanners/updateApplicationBanners',
      ...
      async update() {
        ...
        if (!this.error) {
          this.$router.replace(this.localePath('/admin/application_banners'))
        }
      },
      async updateAndContinue() {
        await this.updateApplicationBanners({
