        ...
        <div class="row g-0">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.application_banner.create_new_application_banner") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              <ol class="breadcrumb float-sm-right text-body">
                ...
                <li class="breadcrumb-item">
                  <nuxt-link :to="localePath('/admin/application_banners')">{{
                    this.$t("sidebar.application_banner")
                  }}</nuxt-link>
                </li>
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.application_banner.form_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
...
export default {
  ...
  meta: {
    permission: "application_banners.create",
    strategy: "create",
  },
  async fetch() {
  ...
  methods: {
    ...mapActions({
      addApplicationBanners: "ApplicationBanners/addApplicationBanners",
    ...
    async addAndContinue() {
      await this.addApplicationBanners(this.formData).then((res) => {
        // some error occur
        if (res.response) {
          ...
          this.application_banner_image_path = "";
