        ...
        <div class="row g-0">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.content_application_page.view_content_page") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              <ol class="breadcrumb float-sm-right text-body">
                ...
                <li class="breadcrumb-item">
                  <nuxt-link :to="localePath('/admin/content_application_pages')">{{ this.$t("sidebar.content_application_page") }}</nuxt-link>
                </li>
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.content_application_page.view_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
            ...
            <div class="card gutter-b border-0">
              <div class="card-body">
                ...
                <div class="row justify-content-end">
                  ...
                  <div class="col-3">
                    <p>{{content_application_page.slug }}</p>
                  </div>
                  ...
                  <div class="col-3">
                    <div class="form-switch">
                      <input
                        ...
                        :checked="content_application_page.is_active ? 'checked' : ''"
                        type="checkbox"
                                    ...
                                    <div class="col-md-6 my-1">
                                      <div role="group ">
                                        <div role="group">
                                          ...
                                          >
                                            {{
                                            content_application_page.nameTranslations[
                                                language.code
                                              ]
                                            }}
                                          </div>
                                    ...
                                    <div class="col-md-12 my-1">
                                      <div role="group ">
                                        <div role="group">
                                          <label for="input-live form-label">{{
                                            $t(
                                              "form.content_application_page.description.label"
                                            )
                                          }}</label>
                                          <div
...
<script >
  ...
  export default {
    ...
    async fetch() {
      const { data } = await this.$repositories.content_application_pages.show(this.$route.params.id)
      this.content_application_page = data
    },
    methods: {},
    mounted() {},
    computed: {
