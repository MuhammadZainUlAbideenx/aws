        ...
        <div class="row">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.content_application_page.create_new_content_application_page") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.content_application_page.form_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
...
export default {
  ...
  meta: {
    permission: "content_application_pages.create",
    strategy: "create",
  },
 fetch() {
  ...
  data() {
    return {
      ...
      url: "/backend",
      content_application_page_image_path: "",
      formData: {
        name: {},
        description: {},
        slug: "",
  ...
  methods: {
    ...mapActions({
      addContentApplicationPages: "ContentApplicationPages/addContentApplicationPages",
    ...
    async addAndContinue() {
      await this.addContentApplicationPages(this.formData).then((res) => {
        // some error occur
        if (res.response) {
