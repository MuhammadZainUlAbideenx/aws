      ...
      <div class="container-fluid mb-5 custom-vue-dropzone" >
        <div class="row my-4">
          <div class="col-sm-12 col-md-4 col-lg-2 gutter-b">
            <div class="p-3 dropzone-area h-100 rounded-md">
...
export default {
  ...
  methods: {
    ...
    deleteMedia(id) {
      this.$media.deleteMedia(id).then(async (response) => {
        this.pagination.page = 1
        const { media } = await this.$media.fetchMedia(this.pagination);
        this.media.data = media.data;
        this.media.meta = media.meta
        ...
        this.notifyVue('top', 'right','success',this.$t('file_deleted_successfully'));
      });
    },
    async loadmore(){
