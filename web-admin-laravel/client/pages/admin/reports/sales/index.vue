        ...
        <div class="card gutter-b bsale-0">
          <div class="card-header p-0">
            <div class="row table-filter-row g-0 justify-content-end">
                ...
                <div class="d-flex flex-column flex-md-row">
                  ...
                  >
                    ...
                    <option value="shipping_price">
                      {{
                        $t("columns.order_time_currency_display_shipping_price")
                      }}
                    </option>
              ...
              <div class="col-lg-5 col-md-10 pt-md-3 pt-lg-0 ps-lg-0 ps-md-0">
                <div class="d-flex flex-column flex-md-row">
              ...
              <div class="col-md-12">
                <div class="mt-3 form-group position-relative ms-0">
                  <button
                    data-v-cba73d34=""
                    type="button"
                    name="button"
...
export default {
  ...
  methods: {
    async exportSales(type) {
      ...
      await this.$generalService.saleExport(this.filterData);
    },
    async filter() {
      this.getReports();
    },
    async getReports() {
      ...
      const data = await this.$generalService.getSaleReports(this.filterData);
      if (data.success) {
        this.loading = false;
