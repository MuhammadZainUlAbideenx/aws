      ...
      <div class="row g-0">
        <div class="col-sm-12 px-0">
          <h2 class="m-0 text-body bold">
            {{ this.$t("form.manufacturer.edit_manufacturer") }}
          </h2>
        </div>
        <!-- /.col -->
        <div class="row">
          <div class="col-sm-12 px-0">
            <ol class="breadcrumb float-sm-right text-body">
              ...
              <li class="breadcrumb-item">
                <nuxt-link :to="localePath('/admin/manufacturers')">{{
            ...
            <p class="text-body-secondary mb-0">
              {{ this.$t("form.manufacturer.edit_description") }}
            </p>
          </div>
          <!-- /.col -->
        </div>
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-6 my-1 ps-md-0">
                  ...
                  <div class="">
                    <img
                      v-if="manufacturer_image_path"
                      v-bind:src="url + `${manufacturer_image_path}`"
                      class=""
                    />
                    <div
                      ...
                      data-bs-target="#selectManufacturerMedia"
                    >
                      {{ $t("form.select_media") }}
                    </div>
                    <AdminMediaModal
                      type="images"
                      bind_modal="image_id"
                      img_var="manufacturer_image_path"
                      modal_id="selectManufacturerMedia"
                ...
                <div class="col-md-6 my-1 pe-md-0">
                  <div role="group">
                    <label for="input-live" class="form-label"
                      >{{
                        this.$t("form.manufacturer.website_url.label")
                      }}:</label
                    >
                    <span
                      class="float-end text-danger"
                    ...
                    <input
                      ...
                      :placeholder="
                        this.$t('form.manufacturer.website_url.placeholder')
                      "
                      trim
                    />
                    <span class="heebo-light">
              ...
              <div class="row">
                <div class="col-lg-12 px-0">
                  <div class="">
                    <div class="px-0 py-4">
                      <h2 class="m-0 text-body bold">Multilanguage</h2>
                      <p>
                        <span class="heebo-light">
...
export default {
  ...
  async fetch() {
    ...
    const { data } = await this.$repositories.manufacturers.show(
    ...
    if (data.image) {
      ...
      if (data.image.thumbnails) {
        this.manufacturer_image_path = data.image.thumbnails.small.thumbnail;
      }
    }
  ...
  methods: {
    ...mapActions({
      updateManufacturers: "Manufacturers/updateManufacturers",
    ...
    async updateAndContinue() {
      this.disabled = true;
      await this.updateManufacturers({
