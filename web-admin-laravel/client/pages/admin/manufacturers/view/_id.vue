<template >
  <div>
      ...
      <div class="row g-0">
        <div class="col-sm-12 px-0">
          <h2 class="m-0 text-body bold">
            {{ this.$t("form.manufacturer.view_manufacturer") }}
          </h2>
        </div>
        <!-- /.col -->
        <div class="row">
          <div class="col-sm-12 px-0">
            ...
            <p class="text-body-secondary">
              {{ this.$t("form.manufacturer.view_description") }}
            </p>
          </div>
          <!-- /.col -->
        </div>
    ...
    <section class="content">
      ...
      <div class="container animate__animated animate__fadeInUp" v-else>
        <div class="row">
          <div class="col-lg-12">
                    ...
                    <div role="group">
                      ...
                      <div class="py-2">
                        <img
                          ...
                          width="300px"
                          height="300px"
                          v-if="manufacturer && manufacturer.image"
                          v-bind:src="
                            url + `${manufacturer.image.original_media_path}`
                          "
                        />
                      </div>
                    </div>
                        ...
                        <div class="col-6">
                          <div class="form-switch">
                            <input
                              ...
                              :checked="manufacturer.is_active ? 'checked' : ''"
                              type="checkbox"
