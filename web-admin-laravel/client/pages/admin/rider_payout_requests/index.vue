...
export default {
  ...
  methods: {
    ...mapActions({
      fetchRiderPayoutRequests: "RiderPayoutRequests/fetchRiderPayoutRequests",
      filterRiderPayoutRequests: "RiderPayoutRequests/filterRiderPayoutRequests",
      updateRiderPayoutRequestStatus: "RiderPayoutRequests/updateRiderPayoutRequestStatus",
    }),
    async exportOrders(type) {
      this.filterData.export = type;
      await this.$repositories.riderPayoutRequests.export(this.filterData);
    },
  ...
  computed: {
    ...mapGetters({
      allRiderPayoutRequests: "RiderPayoutRequests/allRiderPayoutRequests",
    }),
  },
  mounted() {},
  watch: {
