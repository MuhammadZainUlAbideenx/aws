        ...
        <div class="row g-0">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.admin.create_new_admin") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.admin.form_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
                  ...
                  <div class="col-md-6 ps-md-0">
                    <div role="group">
                      ...
                      <span class="float-end text-danger"
                        ...
                        <AdminSearchSelectable :class="error && error.role_id ? 'error' : ''" apiMethod="allActiveAdminsRoles" responseKey="admins_types"
                          :initialOptions="allActiveAdminsRoles.admins_types" show_key="display_name" :placeholder="this.$t('form.admin.admin_type.placeholder')" v-model="formData.role_id"/>
                  ...
                  <div class="col-md-6 pe-md-0">
                    ...
                    <label class="label form-label">
                      ...
                      <span class="float-end text-danger"
                        ...
                        <datetime :min-datetime="now.min_date"  :max-datetime="now.max_date" value-zone="local" :placeholder="this.$t('form.admin.dob.placeholder')"   input-class="form-control" type="date" v-model="formData.dob"></datetime>
                   <span class="  heebo-light">
                  ...
                  <div role="group">
                    ...
                    <span class="float-end text-danger"
                      ...
                      <AdminSearchSelectable :class="error && error.country_id ? 'error' : ''" apiMethod="activeCountries" responseKey="countries"
                        :initialOptions="allActiveCountries.countries" :placeholder="this.$t('form.admin.country.placeholder')" v-model="formData.country_id" v-on:input="getStatesByCountry($event)" />
                           <span class=" heebo-light">
                  ...
                  <div role="group">
                    ...
                    <span class="float-end text-danger"
                      ...
                      <AdminSearchSelectable :class="error && error.state_id ? 'error' : ''" :search_id="formData.country_id" apiMethod="getStatesByCountry" responseKey="states"
                        :initialOptions="statesByCountry.states" :placeholder="this.$t('form.admin.state.placeholder')" :key="states_key" v-model="formData.state_id" v-on:input="getCitiesByState($event)" />
                           <span class=" heebo-light">
                  ...
                  <div role="group">
                    ...
                    <span class="float-end text-danger"
                      ...
                      <AdminSearchSelectable :class="error && error.city_id ? 'error' : ''" :search_id="formData.state_id" apiMethod="getCitiesByState" responseKey="cities"
                        :initialOptions="citiesByState.cities" :placeholder="this.$t('form.admin.city.placeholder')" :key="cities_key" v-model="formData.city_id" />
                           <span class=" heebo-light">
  ...
  async fetch(){
    ...
    methods: {
      ...
      async addAndContinue() {
        await this.addAdmins(this.formData).then(res => {
          // some error occur
          if (res.response) {
