        ...
        <div class="row g-0">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.news_category.view_news_category") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.news_category.view_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12 px-0">
                    <div class="show-table px-0 mb-3">
                      <div class="row justify-content-end">
                        <div class="col-sm-6">
                          <div role="group">
                            <label for="input-live" class="form-label"> {{ this.$t("form.news_category.image.label") }}</label>
                                <div class="py-2">
                        <img
                          ...
                          "
                          v-bind:src="
                            url + `${news_category.image.original_media_path}`
                          "
                        />
                      </div>
                            </div>
                  ...
                  <input class="form-check-input"
                         :checked="news_category.is_active ? 'checked' : ''"
                         type="checkbox"
                                    ...
                                    <div class="col-md-6 my-1">
                                      <div role="group ">
                                        <div role="group">
                                          ...
                                          >
                                            {{
                                              news_category.nameTranslations[
                                                language.code
                                              ]
                                            }}
                                          </div>
