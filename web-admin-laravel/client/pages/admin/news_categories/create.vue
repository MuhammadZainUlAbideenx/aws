        ...
        <div class="row g-0">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.news_category.create_new_news_category") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.news_category.form_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
                  ...
                  <div class="col-md-6 my-1 ps-md-0">
                    <label class="label form-label">
                      ...
                      <div class="">
                        ...
                        <img v-if="news_category_image_path" v-bind:src=" url + `${news_category_image_path}`" class="" />
                                ...
                                <div class="col-md-6 my-1">
                                  <div role="group ">
                                    <label for="input-live" class="form-label"
                                      >{{
                                        $t("form.news_category.name.label")
                                      }}:</label
                                    >
                                    <span
                                    ...
                                    <input
                                      ...
                                      :placeholder="
                                        $t('form.news_category.name.placeholder')
                                      "
                                      trim
                                    />
                                    <span class="heebo-light">
                                ...
                                <div class="col-md-12 my-1">
                                  <div role="group ">
                                    <label
                                      ...
                                      >{{
                                        $t(
                                          "form.news_category.description.label"
                                        )
                                      }}:</label
                                    >
                                    <span
                                    ...
                                    <span class="px-2 heebo-light">
                                      {{
                                        $t(
                                          "form.news_category.description.subheading"
                                        )
                                      }}
                                    </span>
                                  </div>
...
<script >
  ...
  export default {
    ...
    meta: {
      permission: 'news_categories.create',
      strategy: 'create'
    },
    async fetch(){
    ...
    methods: {
      ...mapActions({
        addNewsCategories: 'NewsCategories/addNewsCategories',
      ...
      async addAndContinue() {
        await this.addNewsCategories(this.formData).then(res => {
          // some error occur
          if (res.response) {
