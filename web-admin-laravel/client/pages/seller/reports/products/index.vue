                ...
                <div class="card gutter-b bsale-0">
                    <div class="card-header p-0">
                        <div class="row table-filter-row g-0">
                            ...
                            <div class="col-lg-5 col-md-12 pe-0 pe-lg-4">
                            ...
                            <div class="col-md-12 col-lg-7 mt-md-3 mt-lg-0 d-flex flex-column flex-md-row">
                                <div class="col-lg-9 col-md-9">
                                    <div class="d-flex flex-column flex-md-row">
                                        <div class="position-relative form-width mb-4 mb-md-0">
                                                    <datetime
                                                    format="yyyy-MM-dd"
                                ...
                                <div class="col-lg-3 col-md-3">
                                    ...
                                    <div class="share" v-if="rows.length > 0">
                                        <nav>
                                        <span @click="exportSellerProducts('csv')">
                                            <!-- <nuxt-link
                                            to="#"
                                        ...
                                        <span @click="exportSellerProducts('xlsx')">
                                            <!-- <nuxt-link
                                            to="#"
                                        ...
                                        <span @click="exportSellerProducts('pdf')">
                                            <nuxt-link
                                            to="#"
...
export default {
  ...
  async fetch() {},
  methods: {
    async exportSellerProducts(type) {
      this.filterData.export = type;
      await this.$generalService.productSellerExport(this.filterData);
    },
    async filter() {
      this.getReports();
    },
    async getReports() {
      ...
      this.error = false;
      this.errors = "";
      const data = await this.$generalService.getSellerProductReports(
        this.filterData
      );
      if (data.success) {
        this.loading = false;
