        ...
        <div class="row">
          <div class="col-sm-12 px-0">
            <ol class="breadcrumb float-sm-right text-body">
              ...
              <li class="breadcrumb-item">
                <nuxt-link :to="localePath('/seller/orders')">{{
            ...
            <div class="card gutter-b border-0">
              <div class="card-body">
                <div class="row">
                  <div
                    class="col-12"
                    v-for="product in order.vendor_order_products"
                  >
                    <div
                      class="row g-0 my-3 order-items p-3 shadow-sm mb-3 border"
                    >
                      <div
                        class="
                          col-md-3
                    ...
                    <div class="row mt-5">
                      <div class="col-md-6">
                        ...
                        >
                          ...
                          <div class="col-6">
                            <p>{{ order.vendor_addresses.shipping.name }}</p>
                          </div>
                          ...
                          <div class="col-6">
                            <p>{{ order.vendor_addresses.shipping.address }}</p>
                          </div>
                           <div class="col-6" v-if="order.vendor_addresses.shipping.near_by">
                            <label for="input-live " class="form-label">{{
                              this.$t("form.orders.shipping_address.near_by")
                            }}</label>
                          </div>
                          <div class="col-6" v-if="order.vendor_addresses.shipping.near_by">
                            <p>{{ order.vendor_addresses.shipping.near_by }}</p>
                          </div>
                          <!-- <div class="col-6">
                              <label for="input-live " class="form-label">{{
                            ...
                            <div class="col-6">
                              <p>{{ order.vendor_addresses.shipping.phone }}</p>
                            </div> -->
                        </div>
                        ...
                        <div
                          ...
                          "
                        >
                          <h2 class="my-4">{{$t('billing_details')}}</h2>
                          <div class="col-6">
                            <label for="input-live " class="form-label">{{
                          ...
                          <div class="col-6">
                            <p>{{ order.vendor_addresses.billing.name }}</p>
                          </div>
                          ...
                          <div class="col-6">
                            <p>{{ order.vendor_addresses.billing.address }}</p>
                          </div>
                          <div class="col-6" v-if="order.vendor_addresses.billing.near_by">
                            <label for="input-live " class="form-label">{{
                              this.$t("form.orders.billing_address.near_by")
                            }}</label>
                          </div>
                          <div class="col-6" v-if="order.vendor_addresses.billing.near_by">
                            <p>{{ order.vendor_addresses.billing.near_by }}</p>
                          </div>
                          <!-- <div class="col-6">
                              <label for="input-live " class="form-label">{{
                            ...
                            <div class="col-6">
                              <p>{{ order.vendor_addresses.billing.phone }}</p>
                            </div> -->
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div
                          ...
                          "
                        >
                          <h2 class="my-4">{{$t('bill_summary')}}</h2>
                          <div class="col-6">
                            <label for="input-live " class="form-label">{{
                              this.$t(
                                "form.orders.order_time_currency_display_sub_total.label"
                              )
                            }}</label>
                          </div>
                          <div class="col-6">
                           ...
                           <div class="col-6">
                            <label for="input-live " class="form-label">{{
                              this.$t(
                                "form.orders.order_time_currency_display_shipping_price.label"
                              )
                            }}</label>
                          </div>
                          <div class="col-6">
                          ...
                          <div class="col-6">
                            <label for="input-live " class="form-label">{{
                              this.$t(
                                "form.orders.order_time_currency_display_total.label"
                              )
                            }}</label>
                          </div>
                          <div class="col-6">
                        ...
                        <div class="mt-4">
                          <label for="input-live" class="form-label"
                            >{{ $t("form.orders.is_active.label") }}:</label
                          >
                          <div class="form-switch">
                            <input
                              class="form-check-input"
                              :checked="order.is_active ? 'checked' : ''"
                              type="checkbox"
                       ...
                       <div class="col-md-6">
                        ...
                        >
                          <h2 class="my-4">{{$t('rider_details')}}</h2>
                          <div class="col-6">
                            <label for="input-live " class="form-label">{{
                              this.$t(
                                "form.orders.rider.name"
                              )
                            }}</label>
                          </div>
                          <div class="col-6">
                          ...
                          <div class="col-6">
                            <label for="input-live " class="form-label">{{
                              this.$t(
                                "form.orders.rider.order_status"
                              )
                            }}</label>
                          </div>
                          <div class="col-6">
              ...
              <div class="row">
                <div class="col-md-12 px-4 text-center text-md-end mt-5">
                  <button
                    type="button"
...
export default {
  ...
  async fetch() {
    ...
    const { data } = await this.$sellerRepositories.orders.show(
  ...
  methods: {
    ...
    async update() {
      ...
      await this.$generalService
        .changeSellerOrderStatus(this.formData)
        .then((res) => {
          // some error occur
          if (res.response) {
            ...
            this.$router.replace(this.localePath("/seller/orders"));
          }
        })
        .catch((e) => {});
    },
