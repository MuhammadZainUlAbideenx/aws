        ...
        <div class="row g-0">
          <div class="col-sm-12 px-0">
            <h2 class="m-0 text-body bold">
              {{ this.$t("form.static_banner.edit_static_banner") }}
            </h2>
          </div>
          <!-- /.col -->
          <div class="row">
            <div class="col-sm-12 px-0">
              <ol class="breadcrumb float-sm-right text-body">
                ...
                <li class="breadcrumb-item">
                  <nuxt-link :to="localePath('/admin/static_banners')">{{ this.$t("sidebar.static_banner") }}</nuxt-link>
                </li>
              ...
              <p class="text-body-secondary">
                {{ this.$t("form.static_banner.edit_description") }}
              </p>
            </div>
            <!-- /.col -->
          </div>
                  ...
                  <div class="col-md-6 my-1">
                    <div role="group">
                      <label class="label form-label">
                        {{ this.$t("form.static_banner.expiry_date.label") }}
                      </label>
                      <span
                      ...
                      <datetime
                        :placeholder="
                          this.$t('form.static_banner.expiry_date.placeholder')
                        "
                      ...
                      <span class="heebo-light">
                        {{ $t("form.static_banner.expiry_date.subheading") }}
                      </span>
                    </div>
                  </div>
                  <div class="col-md-6 my-1">
                <div role="group">
                  <label for="input-live" class="   form-label">{{ this.$t("form.static_banner.url_type.label") }}:</label>
                  <span class="float-end text-danger"
                    ...
                    <v-select
                      class=""
                      :placeholder="this.$t('form.static_banner.url_type.placeholder')"
                    ...
                    <span class="heebo-light">
                        {{ $t("form.static_banner.url_type.subheading") }}
                    </span>
                </div>
              </div>
                  <div class="col-md-6 my-1">
                    <div role="group">
                      <label for="input-live" class="form-label"
                        >{{
                          this.$t("form.static_banner.website_url.label")
                        }}:</label
                      >
                      <span
                        class="float-end text-danger"
                      ...
                      <input
                        ...
                        :placeholder="
                          this.$t('form.static_banner.website_url.placeholder')
                        "
                        trim
                      />
                      <span class="heebo-light">
                        {{ $t("form.static_banner.website_url.subheading") }}
                      </span>
                    </div>
                  </div>
                  <div class="col-md-6 my-1">
                <div role="group">
                  <label for="input-live" class="form-label">{{ this.$t("form.static_banner.type.label") }}:</label>
                  <span class="float-end text-danger"
                        v-if="error && error.type">
                      {{ error.type[0] }}
                    </span>
                    <v-select
                      class=""
                      :placeholder="this.$t('form.static_banner.type.placeholder')"
                    ...
                    <span class="heebo-light">
                        {{ $t("form.static_banner.type.subheading") }}
                    </span>
                </div>
              </div>
                </div>
                  ...
                  <div class="col-md-6 my-1 d-flex justify-content-center flex-column ">
                      <div class="d-flex align-items-center ">
                          <label class="label form-label me-4 text-capitalize">
                            {{ this.$t("form.static_banner.status.label") }}
                          </label>
                      ...
                      <span class="heebo-light">
                         {{ $t("form.static_banner.status.subheading") }}
                        </span>
                    </div>
                </div>
                              ...
                              <div class="row">
                                <div class="col-md-6 my-1">
                                  <div role="group ">
                                    <label for="input-live" class="form-label"
                                      >{{
                                        $t("form.static_banner.image.label")
                                      }}:</label
                                    >
                                    <span
                                      class="float-end text-danger"
                                    ...
                                    <span class="heebo-light">
                                      {{
                                        $t(
                                          "form.static_banner.image.subheading"
                                        )
                                      }}
                                    </span>
                                  </div>
                              ...
                              <div class="row">
                                <div class="col-md-6 my-1">
                                  <div role="group ">
                                    <label for="input-live" class="form-label"
                                      >{{
                                        $t("form.static_banner.name.label")
                                      }}:</label
                                    >
                                    <span
                                      class="float-end text-danger"
                                    ...
                                    <input
                                      ...
                                      :placeholder="
                                        $t(
                                          'form.static_banner.name.placeholder'
                                        )
                                      "
                                      trim
                                    />
                                    <span class="heebo-light">
                                      {{
                                        $t("form.static_banner.name.subheading")
                                      }}
                                    </span>
                                  </div>
                                </div>
                                ...
                                <div class="col-md-12 my-1">
                                  <div role="group ">
                                    <label for="input-live" class="form-label"
                                      >{{
                                        $t(
                                          "form.static_banner.description.label"
                                        )
                                      }}:</label
                                    >
                                    <span
                                    ...
                                    <span class="heebo-light">
                                      {{
                                        $t(
                                          "form.static_banner.description.subheading"
                                        )
                                      }}
                                    </span>
                                  </div>
...
<script >
  ...
  export default {
    ...
    meta: {
      permission: 'static_banners.update',
      strategy: 'update'
    },
    data() {
      return {
        images:{},
        url_type_options: [
          { value: '', text: this.$t('form.static_banner.url_type.placeholder') },
          { value: 1, text: this.$t('form.static_banner.url_type.internal') },
          { value: 2, text: this.$t('form.static_banner.url_type.external') },
        ],
        options: [
          { value: '', text: this.$t('form.static_banner.type.placeholder') },
          { value: 'home_page', text: this.$t('form.static_banner.type.type_1') },
          { value: 'shop_page', text: this.$t('form.static_banner.type.type_2') },
          { value: 'categories_dropdown', text: this.$t('form.static_banner.type.type_3') },
    ...
    async fetch() {
      ...
      const { data } = await this.$repositories.static_banners.show(this.$route.params.id)
      // get and update data
    ...
    methods: {
      ...mapActions({
        updateStaticBanners: 'StaticBanners/updateStaticBanners',
      ...
      async update() {
        ...
        if (!this.error) {
          this.$router.replace(this.localePath('/admin/static_banners'))
        }
      },
      async updateAndContinue() {
        await this.updateStaticBanners({
