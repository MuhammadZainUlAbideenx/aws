                ...
                <div class="row">
                  <div role="group" class="col-md-6 my-1">
                    ...
                    >
                      ...
                      <option value="0">{{$t('form.rider.commission_type.percentage')}}</option>
                      <option value="1">{{$t('form.rider.commission_type.fixed')}}</option>
                    </select>
...
export default {
  ...
  mounted() {},
  async fetch() {
   await this.getSellerRiderShipping();
  },
  data() {
    return {
      options: [
  ...
  methods: {
async getSellerRiderShipping() {
      const data = await this.$generalService.getSellerRiderShipping();
      if (data) {
    ...
    async update() {
      const data = await this.$generalService.updateSellerRiderCommission(this.formData);
