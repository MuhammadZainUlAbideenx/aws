            ...
            <div class="card gutter-b border-0">
              <div class="card-body">
                ...
                <div class="row justify-content-end">
                  ...
                  <div class="col-3"  v-if="review.customer"><p>{{ review.customer.name }}</p></div>
                  ...
                  <div class="col-3" v-if="review.product"><p>{{ review.product.name }}</p></div>
                  ...
                  <div class="col-3"><p>{{ review.description }}</p></div>
                  ...
                  <div class="col-3"><p>{{ review.review.name }}</p></div>
                  ...
                  <div class="col-3"><p>{{ review.rating }}</p></div>
