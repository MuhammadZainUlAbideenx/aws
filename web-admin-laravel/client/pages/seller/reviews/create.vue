                ...
                <div class="row">
                    ...
                    <div role="group ">
                      ...
                      <span class="float-end text-danger"
                        ...
                        <AdminSearchSelectable :class="error && error.customer_id ? 'error' : ''" apiMethod="activeCustomers" responseKey="customers"
                          :initialOptions="allActiveCustomersSeller" :placeholder="$t('form.review.customer.placeholder')" v-model="formData.customer_id" />
                    ...
                    <div role="group ">
                      ...
                      <span class="float-end text-danger"
                        ...
                        <AdminSearchSelectable :class="error && error.product_id ? 'error' : ''" apiMethod="activeProducts" responseKey="products"
                          :initialOptions="allActiveProductsSeller" :placeholder="$t('form.review.product.placeholder')" v-model="formData.product_id" />
                      <span class="  heebo-light">
                    ...
                    <div role="group ">
                      ...
                      <span class="float-end text-danger"
                        ...
                        <AdminSearchSelectable :class="error && error.review_status_id ? 'error' : ''" apiMethod="activeReviewStatuses" responseKey="review_statuses"
                          :initialOptions="allActiveReviewStatuses.review_statuses" :placeholder="$t('form.review.set_status.placeholder')" v-model="formData.review_status_id" />
                      <span class="  heebo-light">
                          {{ $t("form.review.customer.subheading") }}
                        </span>
                    </div>
                  ...
                  <div class="col-md-6 my-1  pe-md-0">
                    <div role="group">
                      ...
                      <textarea class="form-control" :placeholder="this.$t('form.review.description.placeholder')"  v-model="formData.description" aria-describedby="input-live-help input-live-feedback" rows="8" cols="50"></textarea>
                             <span class="heebo-light">
...
<script >
  ...
  export default {
    ...
    methods: {
      ...mapActions({
        addReviews: 'Seller/Reviews/addReviews',
