  ...
  <div v-else>
      ...
      <div class="row g-0">
        <div class="col-sm-12 px-0">
          <h2 class="m-0 text-body bold">
            {{ this.$t("form.product.create_new_product") }}
          </h2>
        </div>
        <!-- /.col -->
        <div class="row">
          <div class="col-sm-12 px-0">
            ...
            <p class="text-body-secondary">
              {{ this.$t("form.product.form_description") }}
            </p>
          </div>
          <!-- /.col -->
        </div>
    ...
    <section class="content pb-5">
      <div v-if="$fetchState.pending">
        <SellerFormLoader :multilang="true" />
      </div>
          ...
          <div class="col-lg-12">
            <div class="card gutter-b border-0">
              <div class="card-body">
                ...
                <hr class="mb-0" />
                <div class="row categories-parent-section">
                  <div class="col-md-12 mb-3">
                    ...
                    <div v-else>{{$t('did_not_assign_yet')}}</div>
                  </div>
                </div>
                <hr class="mt-0" />
                <div class="row">
                    ...
                    <div role="group">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 pe-0">
                          ...
                          />
                          <span class="heebo-light">
                            {{ $t("form.product.unit.subheading") }}
                          </span>
                        </div>
                      </div>
                    </div>
                ...
                <div class="row" v-if="formData.product_type != 2">
                  <div class="col-md-6 mb-3 d-flex flex-column ps-md-0">
                    <div class="d-flex align-items-center">
                      <label class="label form-label me-4 text-capitalize">
                  ...
                  <div class="col-md-6 mb-3 d-flex flex-column pe-md-0">
                    <div class="d-flex align-items-center">
                      <label class="label form-label me-4 text-capitalize">
                ...
                <div class="col-md-6 my-1">
                  <div role="group">
                    <label for="input-live" class="form-label"
                      >{{ this.$t("form.feature_product.label") }}:</label
                    >
                    <span
                      class="float-end text-danger"
                      v-if="error && error.feature_product_id"
                    >
                      {{ error.feature_products[0] }}
                    </span>
                    <SellerSearchSelectable
                      multiple
                      :class="error && error.feature_products ? 'error' : ''"
                      apiMethod="activeProducts"
                      responseKey="products"
                      :initialOptions="allActiveProducts.products"
                      :placeholder="this.$t('form.related_products.placeholder')"
...
export default {
  ...
  methods: {
    ...mapActions({
      addProducts: "Seller/Products/addProducts",
    ...
    async add() {
      ...
      if (!this.error) {
        ...
        //   this.$router.replace(
        //     this.localePath(
        //       "/seller/products/edit/" + this.product.id + "/step2"
        //     )
        //   );
        // }
      }
    },
    async addAndContinueBtn() {
    ...
    async updateAndNext() {
      ...
      if (!this.error) {
        this.$router.replace(
          this.localePath("/seller/products/edit/" + this.product.id + "/step2")
        );
      }
    },
    async addAndContinue() {
      this.disabled = true;
      await this.addProducts(this.formData).then((res) => {
        // some error occur
        if (res.response) {
