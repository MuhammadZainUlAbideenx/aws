            ...
            <div class="card gutter-b border-0">
              <div class="card-body">
                    ...
                    <div class="row">
                      <div class="show-table px-0">
                        ...
                        {{ product.display_price}}
                          ...
                          <div class="row px-0" v-if="product.special_sale">
                            <div class="col-6">
                              <label for="input-live " class="form-label">
                                {{
                                  this.$t(
                            ...
                            <div class="col-6">
                              <p>{{ product.special_sale.expire_date }}</p>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="col-md-6 my-1 pe-md-0">
                    <div class="show-table">
                      <div class="row justify-content-end">
                        ...
                        <div class="col-6">
                          <p v-if="product.product_type == 1">{{$t('simple_product')}}</p>
                          <p v-if="product.product_type == 2">{{$t('variable_product')}}</p>
                        </div>
                        ...
                        <div class="col-6" v-if="product.manufacturer">
                        ...
                        <div class="col-6" v-if="product.tax_class">
                          <p>{{ product.tax_class.name }}</p>
                        </div>
                        ...
                        <div class="col-6" v-if="product.unit">
                ...
                <div class="row" v-if="product.product_type == 2">
                  <div v-if="product.attributes.length > 0" class="px-0">
                    <div class="col-2">
                      <label for="input-live " class="form-label">
                        <b>{{ this.$t("variants") }}: </b>
                      </label>
                    ...
                    <div class="col-10">
                      <span class="mb-3 d-inline-block w-100"
                        ...
                        <span class="px-2 py-1 border me-2"
                          v-for="(value, index) in attribute.values"
                          :key="index"
                        >
                          {{ value.name }}
                          <span v-if="index < attribute.values.length - 1"
                            >,</span
                          >
                        </span>
                        <br />
