        ...
        <div v-if="currentlyActiveTemplate == 'Template2'">
            <div class="container-fluid signin">
                <div class="row d-flex align-items-center">
                    <div
                        class="col-md-6 py-md-0 py-5 signin-slider d-flex justify-content-center flex-column h-100"
                    >
                        ...
                        <p class="mt-5 mt-md-0 px-lg-3 px-2">{{$t('create_your_account_and_stay_connected_with_us')}}</p>
                    </div>
                    <div
                        class="col-md-6 py-5 signin-form d-flex justify-content-center flex-column h-100"
                    >
                        <h2 class="text-primary mb-5">{{$t('welcome')}}</h2>
